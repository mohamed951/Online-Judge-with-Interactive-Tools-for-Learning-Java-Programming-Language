        ...
        <div class="panel-body text-center">
            ...
            <form action="<?php echo SITE_URL; ?>/process.php" method="post" role="form">
                <div class="input-group" style="margin-bottom: -1px;">
                    ...
                    <input class="form-control" style="border-bottom-right-radius: 0;" type="text" name="teamname" placeholder="Username" required/>
                </div>
...
function contest_status() {
    ...
    <?php
    if ($status['mode'] == "Active" && (isset($_SESSION['loggedin']) && $_SESSION['team']['status'] == 'Admin') ) { ?>
...
function getrankings($code) {
    $result =  Leaderboard::updateContestRankings($code);
