...
<div>
  <div class="panel-group" id="accordion">
      <?php if(isset($_SESSION['loggedin']) && $_SESSION['team']['status'] == 'Admin'){
        ?>
<!---------------------------------------------------- tutorial---------------------------------------------------------------->
      ...
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body">
          <strong>In order to add/update text problem,You should go to "Admin" -> "Problem Setting" -> "Add New Text Problem" or "Edit".</strong><br>
            <table>
                <tr>
                    <th><img class="howtophoto" src="<?php echo SITE_URL; ?>/img/howto/add_update_text_problem.png"/></th>
                    <th>  <img class="howtophoto" src="<?php echo SITE_URL; ?>/img/howto/add_text_problem.png"/></th>
      ...
      <div id="collapse4" class="panel-collapse collapse">
        <div class="panel-body">
          <strong>In order to add/update Expect Output Problem",You should go to "Admin" -> "Problem Setting" -> "Adding Expect Output Problem" or "Edit".</strong><br>
            <table>
                <tr>
                    <th>  <img  class="howtophoto"  src="<?php echo SITE_URL; ?>/img/howto/add_update_Expect_output.png"/><br></th>
                    <th>  <img class="howtophoto" src="<?php echo SITE_URL; ?>/img/howto/add_expect_output_problem.png"/><br></th>
                </tr>
            </table>
          <strong>Name : </strong>Name of the problem.<br>
          <strong>Code : </strong>Unique code.<br>
      ...
      <div id="collapse5" class="panel-collapse collapse">
        <div class="panel-body">
          <strong>In order to add/update Syntax Error Problem,You should go to "Admin" -> "Problem Setting" -> "Adding Syntax Error Problem" or "Edit".</strong><br>
            <table>
                <tr>
                    <th><img class="howtophoto" src="<?php echo SITE_URL; ?>/img/howto/add_syntax_error_problem.png"/><br></th>
                    <th><img class="howtophoto" src="<?php echo SITE_URL; ?>/img/howto/add_update_syntax_error.png"/><br></th>
                </tr>
            </table>table>
          <strong>Name : </strong>Name of the problem.<br>
          <strong>Code : </strong>Unique code.<br>
      ...
      <div id="collapse7" class="panel-collapse collapse">
        <div class="panel-body">
          ...
          <img class="howtophoto" src="<?php echo SITE_URL; ?>/img/howto/create_contest.png"/><br>      
            ...
            <strong>4. </strong>It's preferred to add new problems rather than changing existing practice problem to be contest problem.<br>
            <strong>5. </strong>On the sand-boxed judge which will judge the solutions, ensure that the judge is online.<br>
            <strong>6. </strong>You may now submit your 'correct' solutions to the 'Active' problems and test them to ensure that the system is working properly.<br>
            <strong>7. </strong>Go back to the Judge Settings page and set the status to 'Active'. If you do not specify the 'End Time', a default value of 3 hours will be assumed. student can now login, view problems and submit solutions.<br>
            <strong>8. </strong>When the timer expires, Judge mode will be automatically changed to 'Disabled', and submissions are no longer allowed. It may take a bit longer than that for the judgement of all submissions to take place.<br>
            <strong>9. </strong>If you wish, you may open the submission page of all problems and make certain accepted solutions 'Public' thereby allowing everyone to see the code and can even set the Display IO field in problem settings page to 'Yes' (this will allow Normal users to see their mistakes.<br/>
...
<!-------------------------------------------------Text problem-------------------------------------------------------->
      ...
      <div id="collapse10" class="panel-collapse collapse">
        <div class="panel-body">
            ...
            <Strong>Note:</Strong>When You Submit Your Solution ,You Should Name Your Java Class As "Main"<br>
        </div>
      </div>
    </div>
<!-------------------------------------------------Game-------------------------------------------------------->
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse14">Game</a>
        </h4>
      </div>
      <div id="collapse14" class="panel-collapse collapse">
        <div class="panel-body">
            <img class="howtophoto" src="<?php echo SITE_URL; ?>/img/howto/game.png"/><br>
            In Games,you should acheive the objectives of it by picking up blocks and linking it together to .<br>
        </div>
      </div>
    </div>
...
$( function() {
    ...
    dialog = $( "#dialog" ).dialog({
     ...
     $( ".howtophoto" ).click(function(event) { 
         ...
         document.getElementById("dialogimg").style.height-=580+"px";
         document.getElementById("dialogimg").style.width=780+"px";
         $("#dialog").dialog('open');
        });         
    });
