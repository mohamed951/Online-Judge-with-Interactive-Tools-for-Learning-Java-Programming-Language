...
<!--<div id="score"><img src="coin-clipart-animated-gif-4.gif" width="30" hight="30" id="scoreimgicon" ><h4><span id="hoba" >0</span></h4></div>-->
      ...
      <tr>
		...
		<div class="codeContainer" id="blocklyDiv" style="height: 500px;width:470px;">
			...
			<block type="turn"></block>
		        ...
		        <block type="repeat_untilcar"></block>			
		</xml>
...
<br>
	<input type="submit" value="Run" id="buttonsubmit"class='col-lg-3 btn btn-large btn-primary' onclick="reset1()"/><br>
   ...
   var elem = document.getElementById("animate");  
    ...
    sheckRF=true;
     ...
     counter=0;
       ...
       elem.innerHTML='<img src="img/images%20(1).png" width="100%" hight="100%ٍ" id="elementimg"/>';
                $('#elementimg').css({ transform: "rotate(0deg)" });
        document.getElementById("hoba").innerHTML=0;
       if(resetarr==1)
			arr=[];
...
function down() { 
 ...
 function play(playtimes=0){
     ...
     //alert(elem.style.left+""+elem.style.top);
        if(parseInt(elem.style.top)==375 && parseInt(elem.style.left)==-25 && i>=arr.length){
	...
	if(i<arr.length){
         ...
         if(arr[i]=="Right" && ((parseInt(elem.style.top)==5 && parseInt(elem.style.left)==305)||(parseInt(elem.style.top)==345 && parseInt(elem.style.left)==375)|| (parseInt(elem.style.top)==410 && parseInt(elem.style.left)==40)))
				down();
        ...
        //else if(arr[i]=="Left" && parseInt(elem.style.top)<4) 
			...
			if(elem.style.left==elem.style.top && parseInt(elem.style.left)>=405){
				//elem.style.backgroundColor ="green";
				elem.innerHTML=elem.innerHTML;
                flagicon.style.backgroundImage="url('doneimge.png')";
               // document.getElementById("hoba").innerHTML=parseInt(document.getElementById("hoba").innerHTML)+50;
...
<script>
	...
	function print() {
		...
		var rep=0;
		var fixedBlock="repeat_untilcar";
