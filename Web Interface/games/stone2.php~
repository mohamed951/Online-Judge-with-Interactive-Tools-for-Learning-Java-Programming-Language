       ...
       elem.innerHTML='<img src="img/ezgif.com-rotate.gif" width="100" hight="100" id="elementimg"/>';
        ...
        if(checkimgeicon==false){
            var image = document.createElement("img");
                ...
                image.src = "Diamond.png";            // image.src = "IMAGE URL/PATH"
                image.width="50";
                image.height="50";
...
function down() { 
 ...
 function play(playtimes=0){
     if(playtimes==1)
     	reset1(0);
        if(parseInt(elem.style.left)==400 && parseInt(elem.style.top)==295 && i>=arr.length){
	...
	if(i<arr.length){
         if(arr[i]=="Right" && parseInt(elem.style.top)==-5 && parseInt(elem.style.left)==200 )
				down();
        else if(arr[i]=="forward" && ((parseInt(elem.style.top)==-5 && parseInt(elem.style.left)<200 )|| (parseInt(elem.style.top)<295 && parseInt(elem.style.left)==200)|| (parseInt(elem.style.top)==295 && parseInt(elem.style.left)<400) )) 
			    left();
        else if(arr[i]=="Left" && parseInt(elem.style.top)==295 && parseInt(elem.style.left)==200) 
				up();
