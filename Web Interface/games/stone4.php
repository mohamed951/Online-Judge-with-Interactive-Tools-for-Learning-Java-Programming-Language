	...
	<table border="1"width="500"height="500" id="tablegame">
	  <tr>
		<td class="trackrow"><div style="top:-5px;left:0px"id ="animate"><img src="img/ezgif.com-rotate.gif" width="100%" hight="100%ٍ" id="elementimg" ></div></td>
      ...
      <tr>
        ...
        <td class="tree"></td>
        <td class="trackrow"></td>
        <td class="trackrow"><div id ="dimond"><img src="img/Diamond.png" width="50" hight="50" id="elementdimond" ></div></td>
	  </tr>
	</table>
...
function down() { 
 ...
 function play(playtimes=0){
     if(playtimes==1)
     	reset1(0);
        if(parseInt(elem.style.left)==400 && parseInt(elem.style.top)==395 && i>=arr.length){
 ...
 document.getElementById("hoba").innerHTML=parseInt(document.getElementById("hoba").innerHTML)+50;
	...
	if(i<arr.length){
         if(arr[i]=="Right" && ((parseInt(elem.style.top)==-5 && parseInt(elem.style.left)==0) || (parseInt(elem.style.top)==95 && parseInt(elem.style.left)==100) ||(parseInt(elem.style.top)==195 && parseInt(elem.style.left)==200) || (parseInt(elem.style.top)==295 && parseInt(elem.style.left)==300)) )
				down();
        
        else if(arr[i]=="forward" && ((parseInt(elem.style.top)<95 && parseInt(elem.style.left)==0 && sheckRF==false )|| (parseInt(elem.style.top)<195 && parseInt(elem.style.left)==100 && sheckRF==false )|| (parseInt(elem.style.top)<295 && parseInt(elem.style.left)==200 && sheckRF==false ) ||(parseInt(elem.style.top)<395 && parseInt(elem.style.left)==300 && sheckRF==false ) || (parseInt(elem.style.top)==95 && parseInt(elem.style.left)<100 && sheckRF==true ) || (parseInt(elem.style.top)==195 && parseInt(elem.style.left)<200 && sheckRF==true) || (parseInt(elem.style.top)==295 && parseInt(elem.style.left)<300 && sheckRF==true ) || (parseInt(elem.style.top)==395 && parseInt(elem.style.left)<400 && sheckRF==true ))) 
			    left();
        
        else if(arr[i]=="Left" && ((parseInt(elem.style.top)==95 && parseInt(elem.style.left)==0) || (parseInt(elem.style.top)==195 && parseInt(elem.style.left)==100) ||(parseInt(elem.style.top)==295 && parseInt(elem.style.left)==200) || (parseInt(elem.style.top)==395 && parseInt(elem.style.left)==300))) 
				up();
