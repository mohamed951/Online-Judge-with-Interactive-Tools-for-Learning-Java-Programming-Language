...
function down() { 
 ...
 function play(playtimes=0){
     if(playtimes==1)
     	reset1(0);
        if(parseInt(elem.style.left)==0 && parseInt(elem.style.top)==295 && i>=arr.length){
				elem.innerHTML=elem.innerHTML;
                elem.innerHTML='<img src="img/thumbs_walk-animation_normal.gif" width="100" hight="100" id="elementimg"/>';
 ...
 document.getElementById("hoba").innerHTML=parseInt(document.getElementById("hoba").innerHTML)+50;
	...
	if(i<arr.length){        
         if(arr[i]=="Right" && ((parseInt(elem.style.top)==-5 && parseInt(elem.style.left)==300) || (parseInt(elem.style.top)==295 && parseInt(elem.style.left)==300) ||(parseInt(elem.style.top)==295 && parseInt(elem.style.left)==0)) )
				down();
        else if(arr[i]=="forward" && ((parseInt(elem.style.top)==-5 && parseInt(elem.style.left)<300 )|| (parseInt(elem.style.top)<395 && parseInt(elem.style.left)==300)|| (parseInt(elem.style.top)==295 && parseInt(elem.style.left)>0) )) 
			    left();
        else if(arr[i]=="Left" && parseInt(elem.style.top)==295 && parseInt(elem.style.left)==300) 
				up();
        else{SubmitGame(0);}
