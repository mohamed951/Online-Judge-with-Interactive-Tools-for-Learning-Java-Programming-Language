...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo SITE_URL ?>/css/jquery-ui.css">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo SITE_URL; ?>">EELU OJudge</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo SITE_URL; ?>/rank">Contests Rank</a></li>

                        <?php
                        if(isset($_SESSION['loggedin'])){
                            $team=$_SESSION['team']['name'];   
                             echo  "<li><a href='".SITE_URL."/teams/$team'>Profile</a></li>";
                            }
                        ?>
                            ...
                            <?php if ($_SESSION['team']['status'] == 'Admin') { ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href='<?php echo SITE_URL; ?>/adminTutorial'>Tutorial Settings</a></li><!--mena-->
                                        <?php if ($_SESSION['team']['root'] == 1) { ?>
                                         <li><a href='<?php echo SITE_URL; ?>/adminteam'>User Settings</a></li>
                                        <?php } ?>
                                        ...
                                        <li><a href='<?php echo SITE_URL; ?>/adminbroadcast'>Broadcast</a></li>
                                         ...
                                         <li><a href='<?php echo SITE_URL; ?>/register'>Register Settings</a></li>
                                        <?php } ?>
                                    </ul>
                                </li>                              
                            <?php } ?>
        ...
        <div class="container bodycont">
            <div class='row'>
                ...
                <div class='col-md-2'>
                    <!-- Login Panel -->
                    <div class="panel panel-default" style="background-color:#dedede;">
                        <?php loginbox(); ?>
                    </div>
                    <!-- ./Login Panel -->
        ...
        <div class="footer">
            <a href="<?php echo SITE_URL; ?>">O Judge</a>
        </div>
    </body>
</html>
