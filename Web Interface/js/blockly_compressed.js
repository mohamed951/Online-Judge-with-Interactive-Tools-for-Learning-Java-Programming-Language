...
goog.getObjectByName = function (a, b) {
	for (var c = a.split("."), d = b || goog.global, e = 0; e < c.length; e++)
		if (d = d[c[e]], !goog.isDefAndNotNull(d)) return null;
	return d
};
...
goog.loadModule = function (a) {
	...
	try {
		...
		if (goog.isString(d) && d) goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(d, c) : goog.SEAL_MODULE_EXPORTS &&
			Object.seal && "object" == typeof c && null != c && Object.seal(c), goog.loadedModules_[d] = c;
...
goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function () {
		...
		if (b) {
			var c = [],
				...
				g = function (a) {
					if (!(a in
							e.written || a in e.visited)) {
						e.visited[a] = !0;
						if (a in e.requires)
							for (var b in e.requires[a])
								if (!f.isProvided(b))
									if (b in e.nameToPath) g(e.nameToPath[b]);
									else throw Error("Undefined nameToPath for " + b);
						a in d || (d[a] = !0, c.push(a))
					}
				};
			g(b);
			for (a = 0; a < c.length; a++) b = c[a], this.dependencies_.written[b] = !0;
			for (a = 0; a < c.length; a++)
				if (b = c[a]) {
					var h = e.loadFlags[b] || {},
						k = h.lang || "es3";
					k = this.getTranspiler().needsTranspile(k);
					"goog" == h.module || k ? this.importProcessedScript_(goog.basePath + b, "goog" == h.module, k) : this.importScript_(goog.basePath +
						b)
				} else throw Error("Undefined script input");
		} else throw a = "goog.require could not find: " + a, this.logToConsole(a), Error(a);
		...
		(goog.global.CLOSURE_IMPORT_SCRIPT ||
			goog.bind(this.writeScriptTag_, this))(a, b) && (this.dependencies_.written[a] = !0)
		...
		if (!COMPILED) {
			...
			c && (f = this.getTranspiler().transpile(f,
				a));
	...
	function () {
		...
		if ((a = this.getPathFromDeps_(a)) && a in this.dependencies_.requires)
			for (var b in this.dependencies_.requires[a])
				if (!this.isProvided(b) && !this.isDeferredModule_(b)) return !1;
		return !0
		...
		if (this.inHtmlDocument()) {
			...
			if (void 0 === b)
				...
				} else goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING ? this.appendScriptSrcNode_(a) : this.writeScriptSrcNode_(a);
			else c.write('<script type="text/javascript">' + this.protectScriptTag_(b) + "\x3c/script>");
			return !0
		}
		return !1
	...
	}, goog.DebugLoader.prototype.getTranspiler =
	function () {
			...
			try {
				if (goog.isDef(a))
					...
					if (e[k]) c.push("*** reference loop detected (id=" + k + ") ***");
						...
						c.push("{");
						for (var l in a)
							if (b || !goog.isFunction(a[l])) c.push("\n"), c.push(h), c.push(l +
								" = "), f(a[l], h);
						c.push("\n" + g + "}");
						delete e[k]
					}
...
goog.html.TrustedResourceUrl.prototype.cloneWithParams = function (a) {
	var b = goog.html.TrustedResourceUrl.unwrap(this),
		...
		d;
	for (d in a)
		for (var e = goog.isArray(a[d]) ? a[d] : [a[d]], f = 0; f < e.length; f++) null != e[f] && (b += c + encodeURIComponent(d) + "=" + encodeURIComponent(String(e[f])), c = "&");
...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
	...
	var d = 0,
		...
		h = !1,
		k = !1,
		n = goog.array.toArray(goog.dom.classlist.get(b));
	goog.array.forEach(n, function (a) {
...
goog.ui.PaletteRenderer.prototype.createDom = function (a) {
	...
	a = a.getDomHelper().createDom("DIV", b, this.createGrid(a.getContent(), a.getSize(), a.getDomHelper()));
...
Blockly.Touch.isMouseOrTouchEvent = function (a) {
	return goog.string.startsWith(a.type, "touch") || goog.string.startsWith(a.type, "mouse") || goog.string.startsWith(a.type, "pointer")
};
Blockly.Touch.isTouchEvent = function (a) {
	return goog.string.startsWith(a.type, "touch") || goog.string.startsWith(a.type, "pointer")
};
...
Blockly.VariableMap.prototype.getVariable = function (a, b) {
	...
	if (c)
		for (var d = 0, e; e = c[d]; d++)
			if (Blockly.Names.equals(e.name, a)) return e;
	return null
};
...
Blockly.VariableMap.prototype.getVariableTypes = function () {
	for (var a = Object.keys(this.variableMap_), b = !1, c = 0; c < a.length; c++) "" == a[c] && (b = !0);
	b || a.push("");
	return a
};
Blockly.VariableMap.prototype.getAllVariables = function () {
	for (var a = [], b = Object.keys(this.variableMap_), c = 0; c < b.length; c++) a = a.concat(this.variableMap_[b[c]]);
	return a
};
Blockly.VariableMap.prototype.getVariableUsesById = function (a) {
	for (var b = [], c = this.workspace.getAllBlocks(), d = 0; d < c.length; d++) {
...
Blockly.Bubble = function (a, b, c, d, e, f) {
	...
	this.renderArrow_();
	this.rendered_ = !0;
	a.options.readOnly || (Blockly.bindEventWithChecks_(this.bubbleBack_,
		"mousedown", this, this.bubbleMouseDown_), this.resizeGroup_ && Blockly.bindEventWithChecks_(this.resizeGroup_, "mousedown", this, this.resizeMouseDown_))
};
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
	...
	c = Blockly.utils.createSvgElement("g", c, this.bubbleGroup_);
	this.bubbleArrow_ = Blockly.utils.createSvgElement("path", {}, c);
	this.bubbleBack_ = Blockly.utils.createSvgElement("rect", {
		...
		c);
	b ? (this.resizeGroup_ = Blockly.utils.createSvgElement("g", {
		"class": this.workspace_.RTL ? "blocklyResizeSW" : "blocklyResizeSE"
	}, this.bubbleGroup_), c = 2 * Blockly.Bubble.BORDER_WIDTH, Blockly.utils.createSvgElement("polygon", {
...
Blockly.Bubble.prototype.resizeMouseDown_ = function (a) {
	this.promote_();
	Blockly.Bubble.unbindDragEvents_();
	Blockly.utils.isRightButton(a) || (this.workspace_.startDrag(a, new goog.math.Coordinate(this.workspace_.RTL ? -this.width_ : this.width_, this.height_)), Blockly.Bubble.onMouseUpWrapper_ = Blockly.bindEventWithChecks_(document, "mouseup", this, Blockly.Bubble.bubbleMouseUp_), Blockly.Bubble.onMouseMoveWrapper_ = Blockly.bindEventWithChecks_(document, "mousemove", this, this.resizeMouseMove_), Blockly.hideChaff());
	a.stopPropagation()
};
...
Blockly.Bubble.prototype.layoutBubble_ = function () {
	...
	this.workspace_.RTL ? d - c.viewLeft - a - this.width_ < Blockly.Scrollbar.scrollbarThickness ? a = d - c.viewLeft - this.width_ - Blockly.Scrollbar.scrollbarThickness : d - c.viewLeft - a > c.viewWidth && (a = d - c.viewLeft - c.viewWidth) : d + a < c.viewLeft ? a = c.viewLeft - d : c.viewLeft + c.viewWidth < d + a +
		this.width_ + Blockly.BlockSvg.SEP_SPACE_X + Blockly.Scrollbar.scrollbarThickness && (a = c.viewLeft + c.viewWidth - d - this.width_ - Blockly.Scrollbar.scrollbarThickness);
...
Blockly.Comment.prototype.setVisible = function (a) {
	if (a != this.isVisible())
		if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "commentOpen", !a, a)), !this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a);
		else {
			var b = this.getText(),
				c = this.getBubbleSize();
			a ? (this.bubble_ = new Blockly.Bubble(this.block_.workspace, this.createEditor_(), this.block_.svgPath_, this.iconXY_, this.width_, this.height_), this.bubble_.registerResizeEvent(this.resizeBubble_.bind(this)),
				this.updateColour()) : (this.bubble_.dispose(), this.foreignObject_ = this.textarea_ = this.bubble_ = null);
			this.setText(b);
...
Blockly.Connection.prototype.connect_ = function (a) {
	...
	if (b.isConnected()) {
		var e = b.targetBlock(),
			f = b.getShadowDom();
		b.setShadowDom(null);
		if (e.isShadow()) f = Blockly.Xml.blockToDom(e), e.dispose(), e = null;
		else if (b.type == Blockly.INPUT_VALUE) {
			if (!e.outputConnection) throw "Orphan block does not have an output connection.";
			var g = Blockly.Connection.lastConnectionInRow_(d, e);
			g && (e.outputConnection.connect(g), e = null)
		} else if (b.type ==
			Blockly.NEXT_STATEMENT) {
			if (!e.previousConnection) throw "Orphan block does not have a previous connection.";
		...
		if (e && (b.disconnect(), Blockly.Events.recordUndo)) {
			...
			setTimeout(function () {
				e.workspace && !e.getParent() && (Blockly.Events.setGroup(k), e.outputConnection ? e.outputConnection.bumpAwayFrom_(b) :
					e.previousConnection && e.previousConnection.bumpAwayFrom_(b), Blockly.Events.setGroup(!1))
			}, Blockly.BUMP_DELAY)
		}
		b.setShadowDom(f)
	}
	var n;
	Blockly.Events.isEnabled() && (n = new Blockly.Events.BlockMove(d));
...
Blockly.Connection.prototype.canConnectWithReason_ = function (a) {
	...
	return b && b == c ? Blockly.Connection.REASON_SELF_CONNECTION : a.type != Blockly.OPPOSITE_TYPE[this.type] ? Blockly.Connection.REASON_WRONG_TYPE : b && c && b.workspace !== c.workspace ? Blockly.Connection.REASON_DIFFERENT_WORKSPACES : this.checkType_(a) ? b.isShadow() && !c.isShadow() ? Blockly.Connection.REASON_SHADOW_PARENT :
	...
	switch (this.canConnectWithReason_(a)) {
		...
		case Blockly.Connection.REASON_CHECKS_FAILED:
			throw "Connection checks failed. " +
				(this + " expected " + this.check_ + ", found " + a.check_);
...
Blockly.Connection.prototype.isConnectionAllowed = function (a) {
	if (this.canConnectWithReason_(a) != Blockly.Connection.CAN_CONNECT) return !1;
	if (a.type == Blockly.OUTPUT_VALUE || a.type == Blockly.PREVIOUS_STATEMENT)
		if (a.isConnected() || this.isConnected()) return !1;
	return a.type == Blockly.INPUT_VALUE && a.isConnected() && !a.targetBlock().isMovable() && !a.targetBlock().isShadow() || this.type == Blockly.PREVIOUS_STATEMENT && a.isConnected() && !this.sourceBlock_.nextConnection && !a.targetBlock().isShadow() && a.targetBlock().nextConnection ||
		-1 != Blockly.draggingConnections_.indexOf(a) ? !1 : !0
};
Blockly.Connection.prototype.connect = function (a) {
	this.targetConnection != a && (this.checkConnection_(a), this.isSuperior() ? this.connect_(a) : a.connect_(this))
};
...
Blockly.Connection.prototype.setCheck = function (a) {
	a ? (goog.isArray(a) || (a = [a]), this.check_ = a, this.onCheckChanged_()) : this.check_ = null;
	return this
};
...
Blockly.Connection.prototype.toString = function () {
	...
	else if (b = goog.array.find(a.inputList, function (a) {
...
Blockly.ConnectionDB.prototype.removeConnection_ = function (a) {
	...
	if (-1 == b) throw "Unable to find connection in connectionDB.";
	a.inDB_ = !1;
	this.splice(b, 1)
};
...
Blockly.ConnectionDB.prototype.searchForClosest = function (a, b, c) {
	...
	c = null;
	for (var g = b, h, k = f - 1; 0 <= k && this.isInYRange_(k, a.y_, b);) h = this[k], a.isConnectionAllowed(h, g) && (c = h, g = h.distanceFrom(a)), k--;
	for (; f < this.length && this.isInYRange_(f, a.y_, b);) h = this[f], a.isConnectionAllowed(h, g) && (c = h, g = h.distanceFrom(a)), f++;
	a.x_ = e;
	a.y_ = d;
	return {
		connection: c,
...
Blockly.DraggedConnectionManager = function (a) {
...
Blockly.DraggedConnectionManager.prototype.update = function (a, b) {
	var c = this.closestConnection_,
		d = this.updateClosest_(a);
	d && c && c.unhighlight();
	c = !!this.closestConnection_ && b != Blockly.DELETE_AREA_TOOLBOX;
	var e = !!b && !this.topBlock_.getParent() && this.topBlock_.isDeletable();
	this.wouldDeleteBlock_ = e && !c;
	e && this.closestConnection_ && (this.closestConnection_.unhighlight(), this.closestConnection_ = null);
...
Blockly.DraggedConnectionManager.prototype.initAvailableConnections_ = function () {
	var a = this.topBlock_.getConnections_(!1),
		b = this.topBlock_.lastConnectionInStack_();
	b && b != this.topBlock_.nextConnection && a.push(b);
	return a
};
Blockly.DraggedConnectionManager.prototype.updateClosest_ = function (a) {
	var b = this.closestConnection_;
	this.localConnection_ = this.closestConnection_ = null;
	this.radiusConnection_ = Blockly.SNAP_RADIUS;
	for (var c = 0; c < this.availableConnections_.length; c++) {
		var d = this.availableConnections_[c],
			e = d.closest(this.radiusConnection_, a);
		e.connection && (this.closestConnection_ = e.connection, this.localConnection_ = d, this.radiusConnection_ = e.radius)
	}
	return b != this.closestConnection_
};
...
Blockly.BlockDragger.prototype.startBlockDrag = function (a) {
	...
	this.draggingBlock_.getParent() && (this.draggingBlock_.unplug(), a = this.pixelsToWorkspaceUnits_(a), a = goog.math.Coordinate.sum(this.startXY_, a), this.draggingBlock_.translate(a.x, a.y), this.draggingBlock_.disconnectUiEffect());
	this.draggingBlock_.setDragging(!0);
	this.draggingBlock_.moveToDragSurface_();
	this.workspace_.toolbox_ &&
		(a = this.draggingBlock_.isDeletable() ? "blocklyToolboxDelete" : "blocklyToolboxGrab", this.workspace_.toolbox_.addStyle(a))
};
Blockly.BlockDragger.prototype.dragBlock = function (a, b) {
	var c = this.pixelsToWorkspaceUnits_(b),
		d = goog.math.Coordinate.sum(this.startXY_, c);
...
Blockly.BlockDragger.prototype.endBlockDrag = function (a, b) {
	...
	this.workspace_.toolbox_ && (c = this.draggingBlock_.isDeletable() ? "blocklyToolboxDelete" : "blocklyToolboxGrab", this.workspace_.toolbox_.removeStyle(c));
	Blockly.Events.setGroup(!1)
};
...
Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function () {
	...
	this.wouldDeleteBlock_ ? (a && goog.Timer.callOnce(a.close, 100, a), this.fireMoveEvent_(), this.draggingBlock_.dispose(!1, !0)) : a && a.close();
	return this.wouldDeleteBlock_
};
...
Blockly.BlockDragger.prototype.pixelsToWorkspaceUnits_ = function (a) {
	a = new goog.math.Coordinate(a.x / this.workspace_.scale, a.y / this.workspace_.scale);
	this.workspace_.isMutator && (a = a.scale(1 / this.workspace_.options.parentWorkspace.scale));
	return a
};
Blockly.BlockDragger.prototype.dragIcons_ = function (a) {
	for (var b = 0; b < this.dragIconData_.length; b++) {
		var c = this.dragIconData_[b];
		c.icon.setIconLocation(goog.math.Coordinate.sum(c.location, a))
	}
};
...
Blockly.BubbleDragger.prototype.dragBubble = function (a, b) {
	var c = this.pixelsToWorkspaceUnits_(b);
	c = goog.math.Coordinate.sum(this.startXY_, c);
...
Blockly.BubbleDragger.prototype.endBubbleDrag = function (a, b) {
	...
	this.dragSurface_ && this.dragSurface_.clearAndHide(this.workspace_.getBubbleCanvas());
	this.fireMoveEvent_();
	this.workspace_.setResizesEnabled(!0);
	Blockly.Events.setGroup(!1)
};
...
Blockly.WorkspaceDragger = function (a) {
	this.workspace_ = a;
	this.startDragMetrics_ = a.getMetrics();
	this.startScrollXY_ = new goog.math.Coordinate(a.scrollX, a.scrollY)
};
...
Blockly.WorkspaceDragger.prototype.drag = function (a) {
	var b = this.startDragMetrics_,
		c = goog.math.Coordinate.sum(this.startScrollXY_, a);
	a = Math.min(c.x, -b.contentLeft);
	c = Math.min(c.y, -b.contentTop);
	a = Math.max(a, b.viewWidth - b.contentLeft - b.contentWidth);
	c = Math.max(c, b.viewHeight - b.contentTop - b.contentHeight);
	a = -a - b.contentLeft;
	c = -c - b.contentTop;
	this.updateScroll_(a, c)
};
Blockly.WorkspaceDragger.prototype.updateScroll_ = function (a, b) {
	this.workspace_.scrollbar.set(a, b)
};
...
Blockly.Tooltip.onMouseMove_ = function (a) {
	if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && !Blockly.WidgetDiv.isVisible() && !Blockly.Tooltip.blocked_)
...
Blockly.Tooltip.show_ = function () {
	if (!Blockly.Tooltip.blocked_ && (Blockly.Tooltip.poisonedElement_ = Blockly.Tooltip.element_, Blockly.Tooltip.DIV)) {
		...
		for (var a = Blockly.Tooltip.element_.tooltip; goog.isFunction(a);) a = a();
		...
		a ? c = Math.max(Blockly.Tooltip.MARGINS - window.scrollX, c) : c + Blockly.Tooltip.DIV.offsetWidth >
			b.width + window.scrollX - 2 * Blockly.Tooltip.MARGINS && (c = b.width - Blockly.Tooltip.DIV.offsetWidth - 2 * Blockly.Tooltip.MARGINS);
...
Blockly.Gesture.prototype.doStart = function (a) {
	Blockly.utils.isTargetInput(a) ? this.cancel() : (this.hasStarted_ = !0, Blockly.BlockSvg.disconnectUiStop_(), this.startWorkspace_.updateScreenCalculationsIfScrolled(), this.startWorkspace_.isMutator && this.startWorkspace_.resize(), this.startWorkspace_.markFocused(), this.mostRecentEvent_ = a, Blockly.hideChaff(!!this.flyout_), Blockly.Tooltip.block(), this.targetBlock_ && this.targetBlock_.select(), Blockly.utils.isRightButton(a) ? this.handleRightClick(a) : ((goog.string.caseInsensitiveEquals(a.type,
		"touchstart") || goog.string.caseInsensitiveEquals(a.type, "pointerdown")) && Blockly.longStart_(a, this), this.mouseDownXY_ = new goog.math.Coordinate(a.clientX, a.clientY), this.bindMouseEvents(a)))
};
...
Blockly.Gesture.prototype.handleRightClick = function (a) {
	this.targetBlock_ ? (this.bringBlockToFront_(), Blockly.hideChaff(this.flyout_), this.targetBlock_.showContextMenu_(a)) : this.startWorkspace_ && !this.flyout_ && (Blockly.hideChaff(), this.startWorkspace_.showContextMenu_(a));
	a.preventDefault();
	a.stopPropagation();
	this.dispose()
};
Blockly.Gesture.prototype.handleWsStart = function (a, b) {
	goog.asserts.assert(!this.hasStarted_, "Tried to call gesture.handleWsStart, but the gesture had already been started.");
	this.setStartWorkspace_(b);
	this.mostRecentEvent_ = a;
	this.doStart(a)
};
Blockly.Gesture.prototype.handleFlyoutStart = function (a, b) {
	goog.asserts.assert(!this.hasStarted_, "Tried to call gesture.handleFlyoutStart, but the gesture had already been started.");
	this.setStartFlyout_(b);
	this.handleWsStart(a, b.getWorkspace())
};
Blockly.Gesture.prototype.handleBlockStart = function (a, b) {
	goog.asserts.assert(!this.hasStarted_, "Tried to call gesture.handleBlockStart, but the gesture had already been started.");
	this.setStartBlock(b);
	this.mostRecentEvent_ = a
};
Blockly.Gesture.prototype.handleBubbleStart = function (a, b) {
	goog.asserts.assert(!this.hasStarted_, "Tried to call gesture.handleBubbleStart, but the gesture had already been started.");
...
Blockly.Gesture.prototype.doBlockClick_ = function () {
	this.flyout_ && this.flyout_.autoClose ? this.targetBlock_.disabled || (Blockly.Events.getGroup() || Blockly.Events.setGroup(!0), this.flyout_.createBlock(this.targetBlock_).scheduleSnapAndBump()) : Blockly.Events.fire(new Blockly.Events.Ui(this.startBlock_, "click", void 0, void 0));
	this.bringBlockToFront_();
	Blockly.Events.setGroup(!1)
};
...
Blockly.Gesture.prototype.setStartField = function (a) {
	goog.asserts.assert(!this.hasStarted_, "Tried to call gesture.setStartField, but the gesture had already been started.");
...
Blockly.Gesture.prototype.setStartBlock = function (a) {
	this.startBlock_ || (this.startBlock_ = a, a.isInFlyout && a != a.getRootBlock() ? this.setTargetBlock_(a.getRootBlock()) : this.setTargetBlock_(a))
};
...
Blockly.Gesture.prototype.isFieldClick_ = function () {
	return (this.startField_ ? this.startField_.isCurrentlyEditable() : !1) && !this.hasExceededDragRadius_ && (!this.flyout_ || !this.flyout_.autoClose)
};
Blockly.Gesture.prototype.isWorkspaceClick_ = function () {
	return !this.startBlock_ && !this.startField_ && !this.hasExceededDragRadius_
};
...
Blockly.utils.removeAttribute = function (a, b) {
	goog.userAgent.IE && goog.userAgent.isVersion("10.0") ? a.setAttribute(b, null) : a.removeAttribute(b)
};
Blockly.utils.addClass = function (a, b) {
...
Blockly.utils.removeClass = function (a, b) {
	var c = a.getAttribute("class");
	if (-1 == (" " + c + " ").indexOf(" " + b + " ")) return !1;
	c = c.split(/\s+/);
	for (var d = 0; d < c.length; d++) c[d] && c[d] != b || (c.splice(d, 1), d--);
	c.length ? a.setAttribute("class", c.join(" ")) : Blockly.utils.removeAttribute(a, "class");
	return !0
};
Blockly.utils.hasClass = function (a, b) {
...
Blockly.utils.getRelativeXY = function (a) {
	...
	(a = a.getAttribute("style")) && -1 < a.indexOf("translate") && ((c = a.match(Blockly.utils.getRelativeXY.XY_2D_REGEX_)) || (c = a.match(Blockly.utils.getRelativeXY.XY_3D_REGEX_)), c && (b.x += parseFloat(c[1]), c[3] &&
		(b.y += parseFloat(c[3]))));
	return b
};
...
Blockly.utils.getScale_ = function (a) {
	var b = 1;
	(a = a.getAttribute("transform")) && (a = a.match(Blockly.utils.getScale_.REGEXP_)) && a[0] && (b = parseFloat(a[0]));
	return b
};
...
Blockly.utils.shortestStringLength = function (a) {
...
Blockly.utils.checkMessageReferences = function (a) {
	for (var b = !0, c = Blockly.utils.getMessageArray_(), d = /%{(BKY_[A-Z][A-Z0-9_]*)}/gi, e = d.exec(a); e;) {
		var f = e[1];
		f = f.toUpperCase();
		"BKY_" != f.substr(0, 4) ? (console.log("WARNING: Unsupported message table prefix in %{" + e[1] + "}."), b = !1) : void 0 == c[f.substr(4)] && (console.log("WARNING: No message string for %{" + e[1] + "}."), b = !1);
...
Blockly.utils.tokenizeInterpolation_ = function (a, b) {
	...
	for (var e = 0, f = [], g = null, h = 0; h < d.length; h++) {
		...
		0 == e ? "%" == k ? ((k = f.join("")) && c.push(k), f.length = 0, e = 1) : f.push(k) : 1 == e ? "%" == k ? (f.push(k), e = 0) : b && "0" <= k && "9" >= k ? (e = 2, g = k, (k = f.join("")) && c.push(k), f.length = 0) : "{" == k ? e = 3 : (f.push("%", k), e = 0) : 2 == e ? "0" <= k && "9" >= k ? g += k : (c.push(parseInt(g, 10)), h--, e = 0) : 3 == e && ("" == k ? (f.splice(0, 0, "%{"), h--, e = 0) : "}" != k ? f.push(k) : (e = f.join(""), /[a-zA-Z][a-zA-Z0-9_]*/.test(e) ? (k = e.toUpperCase(),
			(k = goog.string.startsWith(k, "BKY_") ? k.substring(4) : null) && k in Blockly.utils.getMessageArray_() ? (e = Blockly.utils.getMessageArray_()[k], goog.isString(e) ? Array.prototype.push.apply(c, Blockly.utils.tokenizeInterpolation_(e, b)) : b ? c.push(String(e)) : c.push(e)) : c.push("%{" + e + "}")) : c.push("%{" + e + "}"), e = f.length = 0))
	}(k = f.join("")) && c.push(k);
	d = [];
...
Blockly.utils.is3dSupported = function () {
	...
	for (var d in c)
		if (void 0 !== a.style[d]) {
			...
			b = goog.global.getComputedStyle(a);
...
Blockly.Grid.prototype.moveTo = function (a, b) {
	...
	(goog.userAgent.IE || goog.userAgent.EDGE) && this.update(this.scale_)
};
Blockly.Grid.createDom = function (a, b, c) {
	a = Blockly.utils.createSvgElement("pattern", {
		id: "blocklyGridPattern" + a,
		patternUnits: "userSpaceOnUse"
	}, c);
	0 < b.length && 0 < b.spacing && (Blockly.utils.createSvgElement("line", {
		stroke: b.colour
	}, a), 1 < b.length && Blockly.utils.createSvgElement("line", {
		stroke: b.colour
	}, a));
	return a
};
Blockly.Options = function (a) {
	...
	if (b) var c = null,
		...
		h = !1,
		k = !1;
	else c = Blockly.Options.parseToolboxTree(a.toolbox), d = !(!c || !c.getElementsByTagName("category").length), e = a.trashcan, void 0 === e && (e = d), f = a.collapse, void 0 === f && (f = d), g = a.comments, void 0 === g && (g = d), h = a.disable, void 0 === h && (h = d), k = a.sounds, void 0 === k && (k = !0);
	var n = !!a.rtl,
...
Blockly.ScrollbarPair = function (a) {
	...
	Blockly.utils.insertAfter_(this.corner_, a.getBubbleCanvas())
};
...
Blockly.Scrollbar.prototype.setPosition_ = function (a, b) {
	this.position_.x = a;
	this.position_.y = b;
	Blockly.utils.setCssTransform(this.outerSvg_, "translate(" + (this.position_.x + this.origin_.x) + "px," + (this.position_.y + this.origin_.y) + "px)")
};
...
Blockly.Scrollbar.prototype.setOrigin = function (a, b) {
	this.origin_ = new goog.math.Coordinate(a, b)
};
...
Blockly.Trashcan.prototype.createDom = function () {
	...
	var b = Blockly.utils.createSvgElement("clipPath", {
...
Blockly.Variables.allDeveloperVariables = function (a) {
	...
	for (var c = 0; c < b.length; c++) {
		var d = b[c];
		if (d.getDeveloperVars) {
			d = d.getDeveloperVars();
			for (var e = 0; e < d.length; e++) a[d[e]] = d[e]
		}
	}
	b = [];
	for (var f in a) b.push(a[f]);
	return b
};
...
Blockly.Variables.flyoutCategoryBlocks = function (a) {
	...
	if (0 < a.length) {
		...
		if (Blockly.Blocks.variables_set) {
			...
			d = '<xml><block type="variables_set" gap="' + d + '">' + Blockly.Variables.generateVariableFieldXml_(c) + "</block></xml>";
			d = Blockly.Xml.textToDom(d).firstChild;
			b.push(d)
		}
		Blockly.Blocks.math_change && (d = Blockly.Blocks.variables_get ? 20 : 8, d = '<xml><block type="math_change" gap="' + d + '">' +
			Blockly.Variables.generateVariableFieldXml_(c) + '<value name="DELTA"><shadow type="math_number"><field name="NUM">1</field></shadow></value></block></xml>', d = Blockly.Xml.textToDom(d).firstChild, b.push(d));
		for (c = 0; d = a[c]; c++) Blockly.Blocks.variables_get && (d = '<xml><block type="variables_get" gap="8">' + Blockly.Variables.generateVariableFieldXml_(d) + "</block></xml>", d = Blockly.Xml.textToDom(d).firstChild, b.push(d))
	}
	return b
};
		...
		e = function (c) {
			Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, c, function (c) {
				if (c) {
					...
					if (f) {
						var g = c.toLowerCase();
						if (f.type == d) var n = Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", g);
						else n = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE, n = n.replace("%1", g).replace("%2", f.type);
						Blockly.alert(n, function () {
							e(c)
						})
...
Blockly.Variables.promptName = function (a, b, c) {
	Blockly.prompt(a, b, function (a) {
		a && (a = a.replace(/[\s\xa0]+/g, " ").replace(/^ | $/g, ""), a == Blockly.Msg.RENAME_VARIABLE || a == Blockly.Msg.NEW_VARIABLE) && (a = null);
		c(a)
	})
};
...
Blockly.Variables.generateVariableFieldXml_ = function (a) {
	var b = a.type;
	"" == b && (b = "''");
	return '<field name="VAR" id="' + a.getId() + '" variabletype="' + goog.string.htmlEscape(b) + '">' + goog.string.htmlEscape(a.name) + "</field>"
};
...
Blockly.VariablesDynamic.flyoutCategoryBlocks = function (a) {
	...
	if (0 < a.length) {
		if (Blockly.Blocks.variables_set_dynamic) {
			var c = '<xml><block type="variables_set_dynamic" gap="24">' + Blockly.Variables.generateVariableFieldXml_(a[0]) + "</block></xml>";
			c = Blockly.Xml.textToDom(c).firstChild;
			b.push(c)
		}
		if (Blockly.Blocks.variables_get_dynamic)
			for (var d = 0; c = a[d]; d++) c = '<xml><block type="variables_get_dynamic" gap="8">' + Blockly.Variables.generateVariableFieldXml_(c) +
				"</block></xml>", c = Blockly.Xml.textToDom(c).firstChild, b.push(c)
	}
	return b
};
...
Blockly.WorkspaceDragSurfaceSvg.prototype.clearAndHide = function (a) {
	...
	if (!(b && c && Blockly.utils.hasClass(b, "blocklyBlockCanvas") && Blockly.utils.hasClass(c, "blocklyBubbleCanvas"))) throw "Couldn't clear and hide the drag surface.  A node was missing.";
	null != this.previousSibling_ ? Blockly.utils.insertAfter_(b, this.previousSibling_) : a.insertBefore(b, a.firstChild);
	Blockly.utils.insertAfter_(c, b);
	this.SVG_.style.display = "none";
	goog.asserts.assert(0 == this.SVG_.childNodes.length,
...
Blockly.WorkspaceDragSurfaceSvg.prototype.setContentsAndShow = function (a, b, c, d, e, f) {
	goog.asserts.assert(0 == this.SVG_.childNodes.length, "Already dragging a block.");
...
Blockly.Xml.workspaceToDom = function (a, b) {
	...
	c.appendChild(Blockly.Xml.variablesToDom(Blockly.Variables.allUsedVarModels(a)));
...
Blockly.Xml.variablesToDom = function (a) {
	for (var b = goog.dom.createDom("variables"), c = 0, d; d = a[c]; c++) {
		var e = goog.dom.createDom("variable", null, d.name);
...
Blockly.Xml.fieldToDomVariable_ = function (a) {
	null == a.getValue() && (a.initModel(), a.getValue());
	var b = a.getVariable();
	if (!b) throw Error("Tried to serialize a variable field with no variable.");
	var c = goog.dom.createDom("field", null, b.name);
	c.setAttribute("name", a.name);
	c.setAttribute("id", b.getId());
	c.setAttribute("variabletype", b.type);
	return c
};
Blockly.Xml.fieldToDom_ = function (a) {
	if (a.name && a.EDITABLE) {
		if (a instanceof Blockly.FieldVariable) return Blockly.Xml.fieldToDomVariable_(a);
		var b = goog.dom.createDom("field", null, a.getValue());
...
Blockly.Xml.blockToDom = function (a, b) {
	...
	if (d = a.getCommentText()) {
		...
		if ("object" == typeof a.comment) {
			d.setAttribute("pinned", a.comment.isVisible());
			var e = a.comment.getBubbleSize();
	...
	for (var f; f = a.inputList[e]; e++) {
		...
		if (f.type != Blockly.DUMMY_INPUT) {
			...
			f.type == Blockly.INPUT_VALUE ? g = goog.dom.createDom("value") : f.type == Blockly.NEXT_STATEMENT && (g = goog.dom.createDom("statement"));
			d = f.connection.getShadowDom();
			!d || k && k.isShadow() || g.appendChild(Blockly.Xml.cloneShadow_(d));
	...
	if (e = a.getNextBlock()) g = goog.dom.createDom("next", null, Blockly.Xml.blockToDom(e, b)), c.appendChild(g);
	d = a.nextConnection && a.nextConnection.getShadowDom();
	!d || e && e.isShadow() || g.appendChild(Blockly.Xml.cloneShadow_(d));
	return c
};
...
Blockly.Xml.domToWorkspace = function (a, b) {
	...
	try {
		for (var h = 0; h < e; h++) {
			...
			if ("block" == n || "shadow" == n && !Blockly.Events.recordUndo) {
				var p =
					Blockly.Xml.domToBlock(k, b);
				c.push(p.id);
				var l = parseInt(k.getAttribute("x"), 10),
					m = parseInt(k.getAttribute("y"), 10);
				isNaN(l) || isNaN(m) || p.moveBy(b.RTL ? d - l : l, m);
				g = !1
			} else if ("shadow" == n) goog.asserts.fail("Shadow block cannot be a top-level block."), g = !1;
			else if ("variables" == n) {
				if (g) Blockly.Xml.domToVariables(k, b);
...
Blockly.Xml.domToVariables = function (a, b) {
	for (var c = 0, d; d = a.children[c]; c++) {
		var e = d.getAttribute("type"),
			f = d.getAttribute("id");
		d = d.textContent;
		if (null == e) throw Error("Variable with id, " + f + " is without a type");
...
Blockly.Xml.domToBlockHeadless_ = function (a, b) {
	...
	for (var g; g = a.childNodes[e]; e++)
		if (3 != g.nodeType) {
			for (var h = f = null, k = 0, n; n = g.childNodes[k]; k++) 1 == n.nodeType && ("block" == n.nodeName.toLowerCase() ? f = n : "shadow" == n.nodeName.toLowerCase() && (h = n));
			!f && h && (f = h);
			...
			switch (g.nodeName.toLowerCase()) {
				...
				case "next":
					...
					f && (goog.asserts.assert(c.nextConnection, "Next statement does not exist."),
						goog.asserts.assert(!c.nextConnection.isConnected(), "Next statement is already connected."), f = Blockly.Xml.domToBlockHeadless_(f, b), goog.asserts.assert(f.previousConnection, "Next block does not have previous statement."), c.nextConnection.connect(f.previousConnection));
					break;
				default:
	...
	(e = a.getAttribute("deletable")) && c.setDeletable("true" ==
		e);
	...
	if ("shadow" == a.nodeName.toLowerCase()) {
		d = c.getChildren();
		for (e = 0; g = d[e]; e++) goog.asserts.assert(g.isShadow(), "Shadow block not allowed non-shadow child.");
		goog.asserts.assert(0 == c.getVarModels().length, "Shadow blocks cannot have variable references.");
		c.setShadow(!0)
	}
	return c
};
Blockly.Xml.domToFieldVariable_ = function (a, b, c, d) {
	var e = b.getAttribute("variabletype") || "";
	"''" == e && (e = "");
	a = Blockly.Variables.getOrCreateVariablePackage(a, b.id, c, e);
	if (null != e && e !== a.type) throw Error("Serialized variable type with id '" + a.getId() + "' had type " + a.type + ", and does not match variable field that references it: " + Blockly.Xml.domToText(b) + ".");
	d.setValue(a.getId())
};
Blockly.Xml.domToField_ = function (a, b, c) {
	var d = a.getField(b);
	d ? (a = a.workspace, b = c.textContent, d instanceof Blockly.FieldVariable ? Blockly.Xml.domToFieldVariable_(a, c, b, d) : d.setValue(b)) : console.warn("Ignoring non-existent field " + b + " in block " + a.type)
};
...
Blockly.ZoomControls.prototype.createDom = function () {
	...
	var c = Blockly.utils.createSvgElement("clipPath", {
	...
	e.setAttributeNS("http://www.w3.org/1999/xlink",
		"xlink:href", a.options.pathToMedia + Blockly.SPRITE.url);
	c = Blockly.utils.createSvgElement("clipPath", {
	...
	c = Blockly.utils.createSvgElement("image", {
		width: Blockly.SPRITE.width,
		height: Blockly.SPRITE.height,
		y: -92,
		"clip-path": "url(#blocklyZoomresetClipPath" + b + ")"
	}, this.svgGroup_);
	c.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a.options.pathToMedia + Blockly.SPRITE.url);
	Blockly.bindEventWithChecks_(c,
		"mousedown", null,
		function (b) {
			a.markFocused();
...
Blockly.WorkspaceSvg.prototype.getSvgXY = function (a) {
	var b = 0,
		c = 0,
		d = 1;
	if (goog.dom.contains(this.getCanvas(), a) || goog.dom.contains(this.getBubbleCanvas(), a)) d = this.scale;
	do {
...
Blockly.WorkspaceSvg.prototype.createDom = function (a) {
	...
	a && (this.svgBackground_ = Blockly.utils.createSvgElement("rect", {
		height: "100%",
		width: "100%",
		"class": a
	...
	this.options.zoomOptions && this.options.zoomOptions.controls && this.addZoomControls_(a);
	this.isFlyout || (Blockly.bindEventWithChecks_(this.svgGroup_, "mousedown", this, this.onMouseDown_), this.options.zoomOptions && this.options.zoomOptions.wheel && Blockly.bindEventWithChecks_(this.svgGroup_, "wheel", this, this.onMouseWheel_));
...
Blockly.WorkspaceSvg.prototype.dispose = function () {
	...
	this.toolboxCategoryCallbacks_ && (this.toolboxCategoryCallbacks_ = null);
...
Blockly.WorkspaceSvg.prototype.updateScreenCalculationsIfScrolled = function () {
	...
	goog.math.Coordinate.equals(this.lastRecordedPageScroll_, a) || (this.lastRecordedPageScroll_ = a, this.updateScreenCalculations_())
};
...
Blockly.WorkspaceSvg.prototype.setupDragSurface = function () {
	if (this.useWorkspaceDragSurface_ && !this.isDragSurfaceActive_) {
		...
		var a = this.svgBlockCanvas_.previousSibling,
			b = this.getParentSvg().getAttribute("width"),
			c = this.getParentSvg().getAttribute("height"),
...
Blockly.WorkspaceSvg.prototype.setVisible = function (a) {
	...
	this.getFlyout_() && this.getFlyout_().setContainerVisible(a);
			...
			if (!isNaN(c) && !isNaN(d)) {
				...
				do {
					...
					if (!a) {
						...
						f = 0;
						for (var n; n = k[f]; f++)
							if (n.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d)).connection) {
								a = !0;
								break
							}
					}
...
Blockly.WorkspaceSvg.prototype.isDeleteArea = function (a) {
	...
	return this.deleteAreaTrash_ && this.deleteAreaTrash_.contains(a) ? Blockly.DELETE_AREA_TRASH : this.deleteAreaToolbox_ && this.deleteAreaToolbox_.contains(a) ? Blockly.DELETE_AREA_TOOLBOX : Blockly.DELETE_AREA_NONE
};
...
Blockly.WorkspaceSvg.prototype.onMouseWheel_ = function (a) {
	this.currentGesture_ && this.currentGesture_.cancel();
	var b = -a.deltaY / 50,
		c = Blockly.utils.mouseToSvg(a, this.getParentSvg(), this.getInverseScreenCTM());
	this.zoom(c.x, c.y, b);
	a.preventDefault()
};
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
	function b(a) {
		if (a.isDeletable()) m = m.concat(a.getDescendants());
		else {
			a = a.getChildren();
	...
	if (!this.options.readOnly && !this.isFlyout) {
		...
		if (this.options.collapse) {
			for (var k = h = !1, n = 0; n < e.length; n++)
				for (var p = e[n]; p;) p.isCollapsed() ? h = !0 : k = !0, p = p.getNextBlock();
			var l = function (a) {
...
Blockly.WorkspaceSvg.prototype.zoom = function (a, b, c) {
	...
	this.scale != c && (this.scrollbar && (a = f.getCTM().translate(a *
		(1 - d), b * (1 - d)).scale(d), this.scrollX = a.e - e.absoluteLeft, this.scrollY = a.f - e.absoluteTop), this.setScale(c))
};
...
Blockly.WorkspaceSvg.prototype.zoomToFit = function () {
	...
	if (c) {
		...
		this.scrollbar || (c += a.contentLeft, b += a.contentTop);
...
Blockly.WorkspaceSvg.getContentDimensions_ = function (a, b) {
	return a.scrollbar ? Blockly.WorkspaceSvg.getContentDimensionsBounded_(a, b) : Blockly.WorkspaceSvg.getContentDimensionsExact_(a)
};
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function () {
	...
	if (this.toolbox_)
		if (this.toolboxPosition == Blockly.TOOLBOX_AT_TOP || this.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM) c.height -= a.height;
		else if (this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT || this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT) c.width -= a.width;
	var d = Blockly.WorkspaceSvg.getContentDimensions_(this,
			c),
		e = 0;
	this.toolbox_ && this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT && (e = a.width);
	var f = 0;
	this.toolbox_ && this.toolboxPosition == Blockly.TOOLBOX_AT_TOP && (f = a.height);
	return {
...
Blockly.WorkspaceSvg.prototype.registerButtonCallback = function (a, b) {
	goog.asserts.assert(goog.isFunction(b), "Button callbacks must be functions.");
...
Blockly.WorkspaceSvg.prototype.registerToolboxCategoryCallback = function (a, b) {
	goog.asserts.assert(goog.isFunction(b), "Toolbox category callbacks must be functions.");
	this.toolboxCategoryCallbacks_[a] = b
};
Blockly.WorkspaceSvg.prototype.getToolboxCategoryCallback = function (a) {
	return (a = this.toolboxCategoryCallbacks_[a]) ? a : null
};
...
Blockly.WorkspaceSvg.prototype.getGesture = function (a) {
	...
	return c ? b && c.hasStarted() ? (console.warn("tried to start the same gesture twice"), c.cancel(), null) : c : b ? this.currentGesture_ = new Blockly.Gesture(a, this) : null
};
...
Blockly.Mutator.prototype.updateEditable = function () {
	this.block_.isInFlyout || (this.block_.isEditable() ? this.iconGroup_ && Blockly.utils.removeClass(this.iconGroup_, "blocklyIconGroupReadonly") : (this.setVisible(!1), this.iconGroup_ && Blockly.utils.addClass(this.iconGroup_, "blocklyIconGroupReadonly")));
	Blockly.Icon.prototype.updateEditable.call(this)
};
...
Blockly.Extensions.register = function (a, b) {
	if (!goog.isString(a) || goog.string.isEmptyOrWhitespace(a)) throw Error('Error: Invalid extension name "' + a + '"');
	if (Blockly.Extensions.ALL_[a]) throw Error('Error: Extension "' + a + '" is already registered.');
	if (!goog.isFunction(b)) throw Error('Error: Extension "' + a + '" must be a function');
	Blockly.Extensions.ALL_[a] = b
};
Blockly.Extensions.registerMixin = function (a, b) {
	if (!goog.isObject(b)) throw Error('Error: Mixin "' + a + '" must be a object');
...
Blockly.Extensions.registerMutator = function (a, b, c, d) {
	...
	if (c && !goog.isFunction(c)) throw Error('Extension "' + a + '" is not a function');
	Blockly.Extensions.register(a, function () {
...
Blockly.Extensions.apply = function (a, b, c) {
	...
	if (!goog.isFunction(d)) throw Error('Error: Extension "' + a + '" not found.');
	...
	return function () {
		...
		this.setTooltip(function () {
			...
			null == e ? -1 === c.indexOf(this.type) && (d = "No tooltip mapping for value " + d + " of field " + a, null != this.type && (d += " of block type " +
				this.type), console.warn(d + ".")) : e = Blockly.utils.replaceMessageReferences(e);
			return e
		}.bind(this))
	}
};
...
Blockly.Extensions.buildTooltipWithFieldValue = function (a, b) {
	"object" == typeof document && Blockly.utils.runAfterPageLoad(function () {
		Blockly.utils.checkMessageReferences(a)
	});
	return function () {
		this.setTooltip(function () {
			return Blockly.utils.replaceMessageReferences(a).replace("%1", this.getFieldValue(b))
		}.bind(this))
	}
};
...
Blockly.Field.prototype.init = function () {
	this.fieldGroup_ || (this.fieldGroup_ = Blockly.utils.createSvgElement("g", {}, null), this.visible_ || (this.fieldGroup_.style.display = "none"), this.borderRect_ = Blockly.utils.createSvgElement("rect", {
			...
			y: 0,
			height: 16
		}, this.fieldGroup_), this.textElement_ = Blockly.utils.createSvgElement("text", {
			"class": "blocklyText",
...
Blockly.Field.prototype.setValue = function (a) {
	if (null !== a) {
		var b = this.getValue();
		b != a && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_, "field", this.name, b, a)), this.setText(a))
	}
};
...
Blockly.Input = function (a, b, c, d) {
	if (a != Blockly.DUMMY_INPUT && !b) throw "Value inputs and statement inputs must have non-empty name.";
	this.type = a;
	this.name = b;
	this.sourceBlock_ = c;
	this.connection = d;
...
Blockly.Input.prototype.insertFieldAt = function (a, b, c) {
	...
	if (!b && !c) return a;
	goog.isString(b) && (b = new Blockly.FieldLabel(b));
...
Blockly.Warning.textToDom_ = function (a) {
	var b = Blockly.utils.createSvgElement("text", {
		"class": "blocklyText blocklyBubbleText",
		y: Blockly.Bubble.BORDER_WIDTH
	}, null);
	a = a.split("\n");
	for (var c = 0; c < a.length; c++) {
		var d = Blockly.utils.createSvgElement("tspan", {
				dy: "1em",
				x: Blockly.Bubble.BORDER_WIDTH
			}, b),
...
Blockly.Warning.prototype.setVisible = function (a) {
	if (a != this.isVisible())
		if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "warningOpen", !a, a)), a) {
...
Blockly.Block = function (a, b, c) {
	"undefined" !== typeof Blockly.Generator.prototype[b] && console.warn('FUTURE ERROR: Block prototypeName "' + b + '" conflicts with Blockly.Generator members. Registering Generators for this block type will incur errors.\nThis name will be DISALLOWED (throwing an error) in future versions of Blockly.');
	...
	this.RTL = a.RTL;
	b && (this.type = b, c = Blockly.Blocks[b], goog.asserts.assertObject(c, 'Error: Unknown block type "%s".', b), goog.mixin(this, c));
	a.addTopBlock(this);
	...
	goog.isFunction(this.onchange) && this.setOnChange(this.onchange)
};
...
Blockly.Block.prototype.setParent = function (a) {
	if (a != this.parentBlock_) {
		if (this.parentBlock_) {
			...
			if (this.previousConnection && this.previousConnection.isConnected()) throw "Still connected to previous block.";
...
Blockly.Block.prototype.setColour = function (a) {
	var b = Number(a);
	if (!isNaN(b) && 0 <= b && 360 >= b) {
	 this.hue_ = b, this.colour_ = Blockly.hueToRgb(b);
		}
	else if (goog.isString(a) && /^#[0-9a-fA-F]{6}$/.test(a)) this.colour_ = a, this.hue_ = null;
	 else throw "Invalid colour: " + a;
	
};
Blockly.Block.prototype.setOnChange = function (a) {
	if (a && !goog.isFunction(a)) throw Error("onchange must be a function.");
	this.onchangeWrapper_ && this.workspace.removeChangeListener(this.onchangeWrapper_);
...
Blockly.Block.prototype.getVars = function () {
	for (var a = [], b = 0, c; c = this.inputList[b]; b++)
		for (var d = 0, e; e = c.fieldRow[d]; d++) e instanceof Blockly.FieldVariable && a.push(e.getValue());
	return a
};
Blockly.Block.prototype.getVarModels = function () {
	for (var a = [], b = 0, c; c = this.inputList[b]; b++)
		for (var d = 0, e; e = c.fieldRow[d]; d++) e instanceof Blockly.FieldVariable && (e = this.workspace.getVariableById(e.getValue())) && a.push(e);
	return a
};
Blockly.Block.prototype.updateVarName = function (a) {
	for (var b = 0, c; c = this.inputList[b]; b++)
		for (var d = 0, e; e = c.fieldRow[d]; d++) e instanceof Blockly.FieldVariable && a.getId() == e.getValue() && e.setText(a.name)
};
Blockly.Block.prototype.renameVarById = function (a, b) {
	for (var c = 0, d; d = this.inputList[c]; c++)
		for (var e = 0, f; f = d.fieldRow[e]; e++) f instanceof Blockly.FieldVariable && a == f.getValue() && f.setValue(b)
};
...
Blockly.Block.prototype.setDisabled = function (a) {
	this.disabled != a && (Blockly.Events.fire(new Blockly.Events.BlockChange(this, "disabled", null, this.disabled, a)), this.disabled = a)
};
...
Blockly.Block.prototype.toString = function (a, b) {
	var c = [],
		d = b || "?";
	if (this.collapsed_) c.push(this.getInput("_TEMP_COLLAPSED_INPUT").fieldRow[0].text_);
	else
...
Blockly.Block.prototype.jsonInit = function (a) {
	...
	if (void 0 !== a.colour) {
		var b = a.colour;
		b = goog.isString(b) ? Blockly.utils.replaceMessageReferences(b) : b;
		this.setColour(b)
	}
	for (b = 0; void 0 !== a["message" + b];) this.interpolate_(a["message" + b], a["args" + b] || [], a["lastDummyAlign" + b]), b++;
	...
	void 0 !== a.tooltip && (b = a.tooltip, b = Blockly.utils.replaceMessageReferences(b), this.setTooltip(b));
	void 0 !== a.enableContextMenu && (b = a.enableContextMenu, this.contextMenu = !!b);
	void 0 !== a.helpUrl && (b = a.helpUrl, b = Blockly.utils.replaceMessageReferences(b), this.setHelpUrl(b));
	goog.isString(a.extensions) && (console.warn("JSON attribute 'extensions' should be an array of strings. Found raw string in JSON for '" +
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
	...
	for (g = 0; g < a.length; g++)
		if (e = a[g], "string" == typeof e) b.push([e, void 0]);
			...
			d = f = null;
			do
				if (h = !1, "string" == typeof e) f = new Blockly.FieldLabel(e);
				else switch (e.type) {
					case "input_value":
					...
					case "input_dummy":
						...
						break;
					case "field_label":
						f = Blockly.FieldLabel.fromJson(e);
						break;
					case "field_input":
						f = Blockly.FieldTextInput.fromJson(e);
						break;
					case "field_angle":
						f = Blockly.FieldAngle.fromJson(e);
						break;
					case "field_checkbox":
						f = Blockly.FieldCheckbox.fromJson(e);
						break;
					case "field_colour":
						f = Blockly.FieldColour.fromJson(e);
						break;
					case "field_variable":
						f = Blockly.FieldVariable.fromJson(e);
						break;
					case "field_dropdown":
						f = Blockly.FieldDropdown.fromJson(e);
						break;
					case "field_image":
						f =
							Blockly.FieldImage.fromJson(e);
						break;
					case "field_number":
						f = Blockly.FieldNumber.fromJson(e);
						break;
					case "field_date":
						if (Blockly.FieldDate) {
							f = Blockly.FieldDate.fromJson(e);
							break
						}
					default:
						e.alt && (e = e.alt, h = !0)
...
Blockly.ContextMenu.createWidget_ = function (a) {
	...
	var b = a.getElement();
	Blockly.utils.addClass(b, "blocklyContextMenu");
...
Blockly.ContextMenu.blockDeleteOption = function (a) {
	var b = a.getDescendants(!0).length,
		c = a.getNextBlock();
	c && (b -= c.getDescendants(!0).length);
	return {
...
Blockly.ContextMenu.blockHelpOption = function (a) {
	return {
		enabled: !(goog.isFunction(a.helpUrl) ? !a.helpUrl() : !a.helpUrl),
...
Blockly.ContextMenu.blockDuplicateOption = function (a) {
	var b = !0;
	a.getDescendants().length > a.workspace.remainingCapacity() && (b = !1);
	return {
...
Blockly.BlockSvg = function (a, b, c) {
	...
	this.useDragSurface_ =
		Blockly.utils.is3dSupported() && !!a.blockDragSurface_;
...
Blockly.BlockSvg.prototype.getBoundingRectangle = function () {
	...
	} else d = new goog.math.Coordinate(a.x - b, a.y), a = new goog.math.Coordinate(a.x + c.width - b, a.y + c.height);
	return {
		topLeft: d,
		bottomRight: a
	}
...
Blockly.BlockSvg.prototype.showContextMenu_ = function (a) {
	if (!this.workspace.options.readOnly && this.contextMenu) {
		...
		if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
			c.push(Blockly.ContextMenu.blockDuplicateOption(b));
			this.isEditable() && !this.collapsed_ && this.workspace.options.comments && c.push(Blockly.ContextMenu.blockCommentOption(b));
			if (!this.collapsed_)
				for (var d = 1; d < this.inputList.length; d++)
			...
			c.push(Blockly.ContextMenu.blockDeleteOption(b))
		}
		c.push(Blockly.ContextMenu.blockHelpOption(b));
...
Blockly.BlockSvg.prototype.dispose = function (a, b) {
	if (this.workspace) {
		...
		b && this.rendered && (this.unplug(a), this.disposeUiEffect());
		this.rendered = !1;
		...
		try {
			var e = this.getIcons();
			for (d = 0; d < e.length; d++) e[d].dispose()
		} finally {
			Blockly.Events.enable()
		}
...
Blockly.BlockSvg.prototype.disposeUiEffect = function () {
	...
	var a = this.workspace.getSvgXY(this.svgGroup_),
...
Blockly.BlockSvg.disposeUiStep_ = function (a, b, c, d) {
	...
	1 < e ? goog.dom.removeNode(a) : (a.setAttribute("transform", "translate(" + (a.translateX_ + (b ? -1 : 1) * a.bBox_.width * d / 2 * e) + "," + (a.translateY_ + a.bBox_.height * d * e) + ") scale(" + (1 - e) * d + ")"), setTimeout(Blockly.BlockSvg.disposeUiStep_, 10, a, b, c, d))
};
Blockly.BlockSvg.prototype.connectionUiEffect = function () {
	...
	if (!(1 > this.workspace.scale)) {
		...
		a = Blockly.utils.createSvgElement("circle", {
			cx: a.x,
			cy: a.y,
			r: 0,
			fill: "none",
...
Blockly.BlockSvg.connectionUiStep_ = function (a, b, c) {
	...
	1 < d ? goog.dom.removeNode(a) : (a.setAttribute("r", 25 * d * c), a.style.opacity = 1 - d, Blockly.BlockSvg.disconnectUiStop_.pid_ = setTimeout(Blockly.BlockSvg.connectionUiStep_, 10, a, b, c))
};
...
Blockly.BlockSvg.disconnectUiStep_ = function (a, b, c) {
	...
	1 < d ? a.skew_ = "" : (a.skew_ = "skewX(" + Math.round(Math.sin(d * Math.PI * 3) * (1 - d) * b) + ")", Blockly.BlockSvg.disconnectUiStop_.group = a, Blockly.BlockSvg.disconnectUiStop_.pid = setTimeout(Blockly.BlockSvg.disconnectUiStep_, 10, a, b, c));
...
Blockly.BlockSvg.prototype.updateColour = function () {
	if (!this.disabled) {
		...
		for (a = 0; c = this.inputList[a]; a++) {
			b = 0;
			for (var d; d = c.fieldRow[b]; b++) d.forceRerender()
		}
	}
};
Blockly.BlockSvg.prototype.updateDisabled = function () {
	...
	for (var a = this.getChildren(), b = 0, c; c = a[b]; b++) c.updateDisabled()
};
...
Blockly.BlockSvg.prototype.setDisabled = function (a) {
	this.disabled != a && (Blockly.BlockSvg.superClass_.setDisabled.call(this, a), this.rendered && this.updateDisabled())
};
Blockly.BlockSvg.prototype.setHighlighted = function (a) {
	this.rendered && (a ? (this.svgPath_.setAttribute("filter", "url(#" + this.workspace.options.embossFilterId + ")"), this.svgPathLight_.style.display = "none") : (Blockly.utils.removeAttribute(this.svgPath_, "filter"), delete this.svgPathLight_.style.display))
};
...
Blockly.BlockSvg.prototype.setDeleteStyle = function (a) {
	a ? Blockly.utils.addClass(this.svgGroup_, "blocklyDraggingDelete") : Blockly.utils.removeClass(this.svgGroup_, "blocklyDraggingDelete")
};
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
	...
	for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++)
		if (l.isVisible()) {
			if (n && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT) var m = c[c.length - 1];
			else k = l.type, m = [], m.type = n &&
	...
	for (a = 0; m = c[a]; a++)
		if (m.thicker = !1, m.type == Blockly.BlockSvg.INLINE)
			for (b = 0; l = m[b]; b++)
...
Blockly.BlockSvg.prototype.renderDraw_ = function (a, b) {
	...
	if (this.outputConnection) this.squareBottomLeftCorner_ = this.squareTopLeftCorner_ = !0;
		...
		} else Blockly.BlockSvg.START_HAT && (this.startHat_ = this.squareTopLeftCorner_ = !0, this.height += Blockly.BlockSvg.START_HAT_HEIGHT, b.rightEdge = Math.max(b.rightEdge,
			100));
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function (a, b, c) {
	...
	this.previousConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15), b.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15), a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), b.push(Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT), this.previousConnection.setOffsetInBlock(this.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH, 0));
	a.push("H", c);
	b.push("H", c - .5);
	this.width = c
};
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function (a, b, c) {
	this.height += c + 1;
	this.nextConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH + (this.RTL ? .5 : -.5) + " " + Blockly.BlockSvg.NOTCH_PATH_RIGHT), this.nextConnection.setOffsetInBlock(this.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH, c + 1), this.height += 4);
	this.squareBottomLeftCorner_ ? (a.push("H 0"), this.RTL || b.push("M", "0.5," + (c - .5))) : (a.push("H", Blockly.BlockSvg.CORNER_RADIUS), a.push("a", Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS +
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function (a, b) {
	this.outputConnection ? (this.outputConnection.setOffsetInBlock(0, 0), a.push("V", Blockly.BlockSvg.TAB_HEIGHT), a.push("c 0,-10 -" + Blockly.BlockSvg.TAB_WIDTH + ",8 -" + Blockly.BlockSvg.TAB_WIDTH + ",-7.5 s " + Blockly.BlockSvg.TAB_WIDTH + ",2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",-7.5"), this.RTL ? (b.push("M", -.25 * Blockly.BlockSvg.TAB_WIDTH + ",8.4"), b.push("l", -.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")) : (b.push("V", Blockly.BlockSvg.TAB_HEIGHT - 1.5), b.push("m", -.92 *
		Blockly.BlockSvg.TAB_WIDTH + ",-0.5 q " + -.19 * Blockly.BlockSvg.TAB_WIDTH + ",-5.5 0,-11"), b.push("m", .92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 0.5 H 1")), this.width += Blockly.BlockSvg.TAB_WIDTH) : this.RTL || (this.squareTopLeftCorner_ ? b.push("V", .5) : b.push("V", Blockly.BlockSvg.CORNER_RADIUS));
	a.push("z")
};
Blockly.Events = {};
	...
	for (var d = [], e = Object.create(null), f = 0, g; g = c[f]; f++)
		if (!g.isNull()) {
			...
			k ? g.type == Blockly.Events.MOVE ? (k.newParentId = g.newParentId, k.newInputName = g.newInputName, k.newCoordinate = g.newCoordinate) : g.type == Blockly.Events.CHANGE && g.element == k.element && g.name == k.name ? k.newValue = g.newValue : g.type != Blockly.Events.UI || "click" != g.element || "commentOpen" != k.element && "mutatorOpen" !=
				k.element && "warningOpen" != k.element ? (e[h] = g, d.push(g)) : k.newValue = g.newValue : (e[h] = g, d.push(g))
		}
...
Blockly.Events.Abstract = function (a) {
	this.recordUndo = this.group = this.workspaceId = this.varId = this.blockId = void 0;
	a instanceof Blockly.Block ? (this.blockId = a.id, this.workspaceId = a.workspace.id) : a instanceof Blockly.VariableModel && (this.workspaceId = a.workspace.id, this.varId = a.getId());
...
Blockly.Events.Create.prototype.run = function (a) {
	...
	if (a) a = goog.dom.createDom("xml"), a.appendChild(this.xml), Blockly.Xml.domToWorkspace(a, b);
	else {
		a = 0;
...
Blockly.Events.Delete.prototype.run = function (a) {
	...
	} else a = goog.dom.createDom("xml"), a.appendChild(this.oldXml), Blockly.Xml.domToWorkspace(a, b)
};
...
Blockly.Events.Move.prototype.fromJson = function (a) {
	...
	a.newCoordinate && (a = a.newCoordinate.split(","), this.newCoordinate = new goog.math.Coordinate(parseFloat(a[0]), parseFloat(a[1])))
};
	...
	if (a.type == Blockly.Events.MOVE || a.type == Blockly.Events.CREATE) {
		...
		if (a = b.getBlockById(a.blockId))
			if (a.getParent() && !a.getParent().disabled) {
				b = a.getDescendants();
				a = 0;
				for (var c; c = b[a]; a++) c.setDisabled(!1)
			} else if ((a.outputConnection || a.previousConnection) && !b.isDragging()) {
			do a.setDisabled(!0), a = a.getNextBlock(); while (a)
		}
	}
};
Blockly.Msg = {};
...
Blockly.FieldTextInput.fromJson = function (a) {
	var b = Blockly.utils.replaceMessageReferences(a.text);
	b = new Blockly.FieldTextInput(b, a["class"]);
...
Blockly.FieldTextInput.prototype.setText = function (a) {
	null !== a && (a = String(a), a !== this.text_ && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_, "field", this.name, this.text_, a)), Blockly.Field.prototype.setText.call(this, a)))
};
...
Blockly.FieldTextInput.prototype.showInlineEditor_ = function (a) {
	...
	var d = Blockly.FieldTextInput.FONTSIZE * this.workspace_.scale + "pt";
	b.style.fontSize = d;
	c.style.fontSize = d;
...
Blockly.FieldTextInput.prototype.bindEvents_ = function (a) {
	a.onKeyDownWrapper_ = Blockly.bindEventWithChecks_(a, "keydown", this, this.onHtmlInputKeyDown_);
	a.onKeyUpWrapper_ = Blockly.bindEventWithChecks_(a, "keyup", this, this.onHtmlInputChange_);
	a.onKeyPressWrapper_ = Blockly.bindEventWithChecks_(a, "keypress", this, this.onHtmlInputChange_);
	a.onWorkspaceChangeWrapper_ = this.resizeEditor_.bind(this);
	this.workspace_.addChangeListener(a.onWorkspaceChangeWrapper_)
};
Blockly.FieldTextInput.prototype.unbindEvents_ = function (a) {
	Blockly.unbindEvent_(a.onKeyDownWrapper_);
	Blockly.unbindEvent_(a.onKeyUpWrapper_);
	Blockly.unbindEvent_(a.onKeyPressWrapper_);
	this.workspace_.removeChangeListener(a.onWorkspaceChangeWrapper_)
};
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function (a) {
	var b = Blockly.FieldTextInput.htmlInput_;
	13 == a.keyCode ? Blockly.WidgetDiv.hide() : 27 == a.keyCode ? (b.value = b.defaultValue, Blockly.WidgetDiv.hide()) : 9 == a.keyCode && (Blockly.WidgetDiv.hide(), this.sourceBlock_.tab(this, !a.shiftKey), a.preventDefault())
};
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function (a) {
	a = Blockly.FieldTextInput.htmlInput_;
	var b = a.value;
	b !== a.oldValue_ ? (a.oldValue_ = b, this.setValue(b), this.validate_()) : goog.userAgent.WEBKIT && this.sourceBlock_.render();
	this.resizeEditor_();
...
Blockly.FieldTextInput.prototype.maybeSaveEdit_ = function () {
	var a = Blockly.FieldTextInput.htmlInput_,
		b = a.value;
	if (this.sourceBlock_)
		if (b = this.callValidator(b), null === b) b = a.defaultValue;
...
Blockly.FieldAngle.prototype.showEditor_ = function () {
	...
	if (a.firstChild) {
		...
		var b = Blockly.utils.createSvgElement("circle", {
		...
		for (var c = 0; 360 > c; c += 15) Blockly.utils.createSvgElement("line", {
			x1: Blockly.FieldAngle.HALF + Blockly.FieldAngle.RADIUS,
			y1: Blockly.FieldAngle.HALF,
			x2: Blockly.FieldAngle.HALF +
				Blockly.FieldAngle.RADIUS - (0 == c % 45 ? 10 : 5),
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
	...
	b = Math.atan(-a / c);
	isNaN(b) || (b = goog.math.toDegrees(b), 0 > c ? b += 180 : 0 < a && (b += 360), b = Blockly.FieldAngle.CLOCKWISE ? Blockly.FieldAngle.OFFSET + 360 - b : b - Blockly.FieldAngle.OFFSET, Blockly.FieldAngle.ROUND && (b = Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND), b = this.callValidator(b), Blockly.FieldTextInput.htmlInput_.value =
		b, this.setValue(b), this.validate_(), this.resizeEditor_())
};
Blockly.FieldAngle.prototype.setText = function (a) {
	Blockly.FieldAngle.superClass_.setText.call(this, a);
	this.textElement_ && (this.updateGraph_(), this.size_.width = 0)
};
...
Blockly.FieldCheckbox.fromJson = function (a) {
	return new Blockly.FieldCheckbox(a.checked ? "TRUE" : "FALSE")
};
...
Blockly.FieldCheckbox.prototype.setValue = function (a) {
	...
	this.state_ !== a && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_, "field", this.name, this.state_, a)), this.state_ = a, this.checkElement_ && (this.checkElement_.style.display = a ? "block" : "none"))
};
...
Blockly.FieldColour.prototype.showEditor_ = function () {
	...
	var e = this;
	Blockly.FieldColour.changeEventKey_ = goog.events.listen(c, goog.ui.ColorPicker.EventType.CHANGE, function (a) {
...
Blockly.FieldDropdown.prototype.init = function () {
	this.fieldGroup_ || (this.arrow_ = Blockly.utils.createSvgElement("tspan", {}, null), this.arrow_.appendChild(document.createTextNode(this.sourceBlock_.RTL ? Blockly.FieldDropdown.ARROW_CHAR + " " : " " + Blockly.FieldDropdown.ARROW_CHAR)), Blockly.FieldDropdown.superClass_.init.call(this))
};
Blockly.FieldDropdown.prototype.showEditor_ = function () {
	Blockly.WidgetDiv.show(this, this.sourceBlock_.RTL, null);
	var a = this.createMenu_();
	this.addEventListeners_(a);
	this.positionMenu_(a)
};
Blockly.FieldDropdown.prototype.addEventListeners_ = function (a) {
	this.addActionListener_(a);
	this.addTouchStartListener_(a);
	this.addTouchEndListener_(a)
};
Blockly.FieldDropdown.prototype.addActionListener_ = function (a) {
	var b = this;
	goog.events.listen(a, goog.ui.Component.EventType.ACTION, function (a) {
		if (a = a.target) b.onItemSelected(this, a);
		Blockly.WidgetDiv.hideIfOwner(b);
		Blockly.Events.setGroup(!1)
	})
};
Blockly.FieldDropdown.prototype.addTouchStartListener_ = function (a) {
	a.getHandler().listen(a.getElement(), goog.events.EventType.TOUCHSTART, function (a) {
		this.getOwnerControl(a.target).handleMouseDown(a)
	})
};
Blockly.FieldDropdown.prototype.addTouchEndListener_ = function (a) {
	a.getHandler().listen(a.getElement(), goog.events.EventType.TOUCHEND, function (a) {
...
Blockly.FieldDropdown.prototype.positionMenu_ = function (a) {
	...
	d.height > Blockly.FieldDropdown.MAX_MENU_HEIGHT && (d.height = Blockly.FieldDropdown.MAX_MENU_HEIGHT);
...
Blockly.FieldDropdown.prototype.createWidget_ = function (a) {
	a.render(Blockly.WidgetDiv.DIV);
	Blockly.utils.addClass(a.getElement(), "blocklyDropdownMenu");
	a.setAllowAutoFocus(!0)
};
...
Blockly.FieldDropdown.prototype.trimOptions_ = function () {
	...
	if (goog.isArray(a)) {
		...
		if (!(b || 2 > a.length)) {
			...
			c = Blockly.utils.shortestStringLength(b);
			d = Blockly.utils.commonWordPrefix(b, c);
			var e = Blockly.utils.commonWordSuffix(b,
				c);
...
Blockly.FieldDropdown.prototype.setValue = function (a) {
	if (null !== a && a !== this.value_) {
		this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_, "field", this.name, this.value_, a));
		this.value_ = a;
		for (var b = this.getOptions(), c = 0; c < b.length; c++)
			if (b[c][1] == a) {
				a = b[c][0];
				"object" == typeof a ? (this.imageJson_ = a, this.text_ = a.alt) : (this.imageJson_ = null, this.text_ = a);
				this.forceRerender();
				return
			}
		this.text_ = a;
...
Blockly.FieldDropdown.prototype.updateWidth = function () {
	if (this.imageJson_ && (goog.userAgent.IE || goog.userAgent.EDGE)) {
		var a = Blockly.Field.getCachedWidth(this.arrow_);
		a = Number(this.imageJson_.width) + a + Blockly.BlockSvg.SEP_SPACE_X;
...
Blockly.FieldImage.fromJson = function (a) {
	...
	a = Blockly.utils.replaceMessageReferences(a.alt);
	return new Blockly.FieldImage(b, c, d, a)
};
...
Blockly.FieldImage.prototype.init = function () {
	...
	}, this.fieldGroup_), this.setValue(this.src_), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.setTooltip(this.sourceBlock_), Blockly.Tooltip.bindMouseEvents(this.imageElement_), this.maybeAddClickHandler_())
};
...
Blockly.FieldImage.prototype.maybeAddClickHandler_ = function () {
	this.clickHandler_ && (this.mouseDownWrapper_ = Blockly.bindEventWithChecks_(this.fieldGroup_, "mousedown", this, this.onMouseDown_))
};
...
Blockly.FieldImage.prototype.setValue = function (a) {
	null !== a && (this.src_ = a, this.imageElement_ && this.imageElement_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a || ""))
};
...
Blockly.FieldVariable.prototype.setValue = function (a) {
	...
	var c = b.type;
	if (!this.typeIsAllowed_(c)) throw Error("Variable type doesn't match this field!  Type was " + c);
	this.sourceBlock_ && Blockly.Events.isEnabled() && (c = this.variable_ ? this.variable_.getId() : null, Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_, "field", this.name, c, a)));
	this.variable_ =
		b;
	this.value_ = a;
	this.setText(b.name)
...
Blockly.FieldVariable.dropdownCreate = function () {
	...
	var a = [],
		b = this.getText(),
		c = null;
	this.sourceBlock_ && (c = this.sourceBlock_.workspace);
	if (c) {
		var d = this.getVariableTypes_();
		a = [];
		for (var e = 0; e < d.length; e++) {
			var f = c.getVariablesOfType(d[e]);
			a = a.concat(f)
		}
	}
	a.sort(Blockly.VariableModel.compareByName);
	c = [];
	for (e = 0; e < a.length; e++) c[e] = [a[e].name, a[e].getId()];
	c.push([Blockly.Msg.RENAME_VARIABLE, Blockly.RENAME_VARIABLE_ID]);
	Blockly.Msg.DELETE_VARIABLE && c.push([Blockly.Msg.DELETE_VARIABLE.replace("%1", b), Blockly.DELETE_VARIABLE_ID]);
	return c
};
Blockly.FieldVariable.prototype.onItemSelected = function (a, b) {
	...
	if (this.sourceBlock_ && this.sourceBlock_.workspace) {
		...
		if (c == Blockly.RENAME_VARIABLE_ID) {
			Blockly.Variables.renameVariable(d, this.variable_);
			return
		}
		if (c == Blockly.DELETE_VARIABLE_ID) {
			d.deleteVariableById(this.variable_.getId());
			return
		}
	}
	this.setValue(c)
...
Blockly.Generator.prototype.workspaceToCode = function (a) {
	...
	for (var c = 0, d; d = a[c]; c++) {
		...
		e && (d.outputConnection && (e = this.scrubNakedValue(e)), b.push(e))
	}
	b = b.join("\n");
	b = this.finish(b);
	b = b.replace(/^\s+\n/, "");
...
Blockly.Procedures.flyoutCategory = function (a) {
	...
	if (Blockly.Blocks.procedures_defnoreturn) {
		...
		var e = goog.dom.createDom("field", null, Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE);
		e.setAttribute("name", "NAME");
		d.appendChild(e);
		c.push(d)
	}
	Blockly.Blocks.procedures_defreturn && (d = goog.dom.createDom("block"), d.setAttribute("type", "procedures_defreturn"), d.setAttribute("gap", 16), e = goog.dom.createDom("field", null, Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE), e.setAttribute("name", "NAME"), d.appendChild(e), c.push(d));
	Blockly.Blocks.procedures_ifreturn && (d = goog.dom.createDom("block"),
		d.setAttribute("type", "procedures_ifreturn"), d.setAttribute("gap", 16), c.push(d));
...
Blockly.FlyoutButton = function (a, b, c, d) {
	...
	this.isLabel_ && a ? console.warn("Labels should not have callbacks. Label text: " + this.text_) : this.isLabel_ || a && b.getButtonCallback(a) ? this.callback_ = b.getButtonCallback(a) : console.warn("Buttons should have callbacks. Button text: " + this.text_);
...
Blockly.FlyoutButton.prototype.createDom = function () {
	...
	if (!this.isLabel_) var b = Blockly.utils.createSvgElement("rect", {
	...
	a = Blockly.utils.createSvgElement("rect", {
		"class": this.isLabel_ ? "blocklyFlyoutLabelBackground" : "blocklyFlyoutButtonBackground",
		rx: 4,
		ry: 4
	}, this.svgGroup_);
	var c = Blockly.utils.createSvgElement("text", {
	...
	c.setAttribute("y",
		this.height - Blockly.FlyoutButton.MARGIN);
...
Blockly.Flyout.prototype.createDom = function (a) {
	this.svgGroup_ = Blockly.utils.createSvgElement(a, {
		"class": "blocklyFlyout",
		style: "display: none"
	}, null);
...
Blockly.Flyout.prototype.positionAt_ = function (a, b, c, d) {
	...
	Blockly.utils.setCssTransform(this.svgGroup_, "translate(" + c + "px," + d + "px)");
	this.scrollbar_ && (this.scrollbar_.setOrigin(c, d), this.scrollbar_.resize())
};
...
Blockly.Flyout.prototype.show = function (a) {
	...
	"string" == typeof a && (a = this.workspace_.targetWorkspace.getToolboxCategoryCallback(a), goog.asserts.assert(goog.isFunction(a), "Couldn't find a callback function when opening a toolbox category."), a = a(this.workspace_.targetWorkspace), goog.asserts.assert(goog.isArray(a), "The result of a toolbox category callback must be an array."));
	this.setVisible(!0);
	for (var b = [], c = [], d = this.permanentlyDisabled_.length =
			0, e; e = a[d]; d++)
		if (e.tagName) {
			var f = e.tagName.toUpperCase(),
				g = this.horizontalLayout_ ? this.GAP_X : this.GAP_Y;
			if ("BLOCK" == f) f = Blockly.Xml.domToBlock(e, this.workspace_), f.disabled && this.permanentlyDisabled_.push(f), b.push({
				type: "block",
				block: f
			}), e = parseInt(e.getAttribute("gap"), 10), c.push(isNaN(e) ? g : e);
			else if ("SEP" == e.tagName.toUpperCase()) e = parseInt(e.getAttribute("gap"), 10), !isNaN(e) && 0 < c.length ? c[c.length - 1] = e : c.push(g);
			else if ("BUTTON" == f || "LABEL" == f) e = new Blockly.FlyoutButton(this.workspace_, this.targetWorkspace_,
				e, "LABEL" == f), b.push({
				type: "button",
				button: e
			}), c.push(g)
...
Blockly.Flyout.prototype.createRect_ = function (a, b, c, d, e) {
	b = Blockly.utils.createSvgElement("rect", {
		"fill-opacity": 0,
		x: b,
		y: c,
		height: d.height,
...
Blockly.Flyout.prototype.placeNewBlock_ = function (a) {
	...
	if (!a.getSvgRoot()) throw "oldBlock is not rendered.";
	var c = Blockly.Xml.blockToDom(a);
	b.setResizesEnabled(!1);
	c = Blockly.Xml.domToBlock(c, b);
	if (!c.getSvgRoot()) throw "block is not rendered.";
	...
	b = goog.math.Coordinate.difference(a, d).scale(1 / b.scale);
	c.moveBy(b.x,
		b.y);
	return c
};
...
Blockly.HorizontalFlyout.prototype.setMetrics_ = function (a) {
	...
	b && (goog.isNumber(a.x) && (this.workspace_.scrollX = -b.contentWidth * a.x), this.workspace_.translate(this.workspace_.scrollX + b.absoluteLeft, this.workspace_.scrollY + b.absoluteTop))
};
Blockly.HorizontalFlyout.prototype.position = function () {
	if (this.isVisible()) {
		...
		if (a) {
			...
			this.setBackgroundPath_(a.viewWidth - 2 * this.CORNER_RADIUS, this.height_ - this.CORNER_RADIUS);
			var b = a.absoluteLeft,
				c = a.absoluteTop;
			this.toolboxPosition_ == Blockly.TOOLBOX_AT_BOTTOM && (c += a.viewHeight - this.height_);
			this.positionAt_(this.width_, this.height_, b, c)
		}
	}
};
...
Blockly.HorizontalFlyout.prototype.wheel_ = function (a) {
	var b = a.deltaX;
	if (b) {
		goog.userAgent.GECKO && 1 === a.deltaMode && (b *= 10);
...
Blockly.HorizontalFlyout.prototype.isDragTowardWorkspace = function (a) {
	...
	if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP) {
		if (a < 90 + b && a > 90 - b) return !0
	} else if (a > -90 - b && a < -90 + b) return !0;
	return !1
};
Blockly.HorizontalFlyout.prototype.getClientRect = function () {
	...
	var a = this.svgGroup_.getBoundingClientRect(),
		b = a.top;
	a = a.height;
	if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP) return new goog.math.Rect(-1E9, b - 1E9, 2E9, 1E9 + a);
	if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_BOTTOM) return new goog.math.Rect(-1E9, b, 2E9, 1E9 + a)
};
...
Blockly.VerticalFlyout.prototype.setMetrics_ = function (a) {
	var b = this.getMetrics_();
	b && (goog.isNumber(a.y) && (this.workspace_.scrollY = -b.contentHeight * a.y), this.workspace_.translate(this.workspace_.scrollX + b.absoluteLeft, this.workspace_.scrollY + b.absoluteTop))
};
Blockly.VerticalFlyout.prototype.position = function () {
	if (this.isVisible()) {
		...
		if (a) {
			...
			this.setBackgroundPath_(this.width_ - this.CORNER_RADIUS, a.viewHeight - 2 * this.CORNER_RADIUS);
			var b = a.absoluteTop,
				c = a.absoluteLeft;
			this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT && (c += a.viewWidth - this.width_);
			this.positionAt_(this.width_, this.height_, c, b)
		}
	}
};
...
Blockly.VerticalFlyout.prototype.layout_ = function (a, b) {
	this.workspace_.scale = this.targetWorkspace_.scale;
	for (var c = this.MARGIN, d = this.RTL ? c : c + Blockly.BlockSvg.TAB_WIDTH, e = 0, f; f = a[e]; e++)
		if ("block" == f.type) {
			f = f.block;
			for (var g = f.getDescendants(), h = 0, k; k = g[h]; h++) k.isInFlyout = !0;
			f.render();
			...
			c += h.height + b[e]
		} else "button" == f.type && (this.initFlyoutButton_(f.button, d, c), c +=
			f.button.height + b[e])
};
...
Blockly.VerticalFlyout.prototype.getClientRect = function () {
	...
	var a = this.svgGroup_.getBoundingClientRect(),
		b = a.left;
	a = a.width;
	return this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT ? new goog.math.Rect(b - 1E9, -1E9, 1E9 + a, 2E9) : new goog.math.Rect(b, -1E9, 1E9 + a, 2E9)
};
Blockly.VerticalFlyout.prototype.reflowInternal_ = function () {
	...
	a += Blockly.Scrollbar.scrollbarThickness;
	if (this.width_ != a) {
		for (c = 0; d = b[c]; c++) this.RTL && (e = d.getRelativeToSurfaceXY().x,
			d.moveBy(a / this.workspace_.scale - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH - e, 0)), d.flyoutRect_ && this.moveRectToBlock_(d.flyoutRect_, d);
		if (this.RTL)
			for (c = 0; d = this.buttons_[c]; c++) b = d.getPosition().y, d.moveTo(a / this.workspace_.scale - d.width - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH, b);
		this.width_ = a;
		this.targetWorkspace_.resize()
	}
};
...
Blockly.Toolbox.prototype.populate_ = function (a) {
	...
	if (this.tree_.blocks.length) throw "Toolbox cannot have both blocks and categories in the root level.";
	...
	for (var d = null, e = null, f = 0, g; g = a.childNodes[f]; f++)
		if (g.tagName) switch (g.tagName.toUpperCase()) {
			case "CATEGORY":
				...
				e = this.tree_.createNode(e);
				e.blocks = [];
				b.add(e);
				var h = g.getAttribute("custom");
				h ? e.blocks = h : (h = this.syncTrees_(g, e, c)) && (d = h);
				h = Blockly.utils.replaceMessageReferences(g.getAttribute("colour"));
				goog.isString(h) ? (/^#[0-9a-fA-F]{6}$/.test(h) ? e.hexColour = h : e.hexColour = Blockly.hueToRgb(Number(h)),
					this.hasColours_ = !0) : e.hexColour = "";
				"true" == g.getAttribute("expanded") ? (e.blocks.length && (d = e), e.setExpanded(!0)) : e.setExpanded(!1);
				e = g;
				break;
			case "SEP":
				e && ("CATEGORY" == e.tagName.toUpperCase() ? b.add(new Blockly.Toolbox.TreeSeparator(this.treeSeparatorConfig_)) : (g = parseFloat(g.getAttribute("gap")), !isNaN(g) && e && e.setAttribute("gap", g)));
				break;
			case "BLOCK":
			case "SHADOW":
			case "LABEL":
...
Blockly.Toolbox.prototype.addStyle = function (a) {
	Blockly.utils.addClass(this.HtmlDiv, a)
};
Blockly.Toolbox.prototype.removeStyle = function (a) {
	Blockly.utils.removeClass(this.HtmlDiv, a)
};
...
Blockly.Toolbox.TreeControl.prototype.createNode = function (a) {
	...
	return new Blockly.Toolbox.TreeNode(this.toolbox_, a, this.getConfig(), this.getDomHelper())
};
Blockly.Toolbox.TreeControl.prototype.setSelectedItem = function (a) {
	...
	if (a != this.selectedItem_ && a != b.tree_) {
		...
		c !=
			a && c != this && (c = new Blockly.Events.Ui(null, "category", c && c.getHtml(), a && a.getHtml()), c.workspaceId = b.workspace_.id, Blockly.Events.fire(c));
		a && (b.lastCategory_ = a)
	}
};
...
Blockly.WidgetDiv.position = function (a, b, c, d, e) {
	...
	Blockly.WidgetDiv.positionInternal_(a, b, c.height)
};
...
Blockly.WidgetDiv.positionWithAnchor = function (a, b, c, d) {
	...
	Blockly.WidgetDiv.positionInternal_(a, e, c.height)
};
...
Blockly.createDom_ = function (a, b) {
	...
	var c = Blockly.utils.createSvgElement("svg", {
		...
		d = Blockly.utils.createSvgElement("defs", {}, c),
...
Blockly.createMainWorkspace_ = function (a, b, c, d) {
	...
	!b.hasCategories && b.languageTree && (c = e.addFlyout_("svg"), Blockly.utils.insertAfter_(c, a));
	e.translate(0, 0);
	Blockly.mainWorkspace = e;
	b.readOnly || b.hasScrollbars || e.addChangeListener(function () {
		if (!e.isDragging()) {
			var a = e.getMetrics(),
				c = a.viewLeft + a.absoluteLeft,
				d = a.viewTop + a.absoluteTop;
			if (a.contentTop < d || a.contentTop +
				a.contentHeight > a.viewHeight + d || a.contentLeft < (b.RTL ? a.viewLeft : c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + c))
				for (var k = e.getTopBlocks(!1), n = 0, p; p = k[n]; n++) {
					var l = p.getRelativeToSurfaceXY(),
						m = p.getHeightWidth(),
						q = d + 25 - m.height - l.y;
					0 < q && p.moveBy(0, q);
...
Blockly.init_ = function (a) {
	...
	b.languageTree && (a.toolbox_ ? a.toolbox_.init(a) : a.flyout_ && (a.flyout_.init(a), a.flyout_.show(b.languageTree.childNodes), a.flyout_.scrollToStart(), a.scrollX =
		a.flyout_.width_, b.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT && (a.scrollX *= -1), a.translate(a.scrollX, 0)));
	b.hasScrollbars && (a.scrollbar = new Blockly.ScrollbarPair(a), a.scrollbar.resize());
...
Blockly.onKeyDown_ = function (a) {
	if (!Blockly.mainWorkspace.options.readOnly && !Blockly.utils.isTargetInput(a)) {
		...
		b && !Blockly.selected.workspace.isFlyout && (Blockly.Events.setGroup(!0), Blockly.hideChaff(), Blockly.selected.dispose(!0, !0), Blockly.Events.setGroup(!1))
	}
};
...
Blockly.bindEvent_ = function (a, b, c, d) {
	...
	if (b in Blockly.Touch.TOUCH_MAP)
		for (var g = function (a) {
				...
				e(a);
				a.preventDefault()
			}, h = 0, k; k = Blockly.Touch.TOUCH_MAP[b][h]; h++) a.addEventListener(k, g, !1), f.push([a, k, g]);
	return f
};
