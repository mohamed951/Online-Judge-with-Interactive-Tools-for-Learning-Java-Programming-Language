	...
	customContextMenu: function (a) {
		...
		if (!this.isCollapsed())
			for (e = 0; e < this.arguments_.length; e++) b = {
				enabled: !0
			}, c = this.arguments_[e], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", c), d = goog.dom.createDom("field", null, c), d.setAttribute("name", "VAR"), d = goog.dom.createDom("block", null, d), d.setAttribute("type", "variables_get"), b.callback = Blockly.ContextMenu.callbackFactory(this, d), a.push(b)
	},
...
Blockly.Constants.VariablesDynamic.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
	customContextMenu: function (a) {
		if (!this.isInFlyout) {
			...
			} else b = "variables_get_dynamic", c = Blockly.Msg.VARIABLES_SET_CREATE_GET;
			var d = {
					enabled: 0 < this.workspace.remainingCapacity()
				},
				e = this.getFieldValue("VAR");
			...
			c = goog.dom.createDom("field", null, e);
			c.setAttribute("name", "VAR");
			e = this.workspace.getVariable(e);
			c.setAttribute("variabletype", e.type);
			e = goog.dom.createDom("block", null, c);
