...
Blockly.JavaScript.lists_repeat = function (a) {
    var b = Blockly.JavaScript.provideFunction_("lists_repeat", ["function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(value, n) {", "  var array = [];", "  for (var i = 0; i < n; i++) {", "    array[i] = value;", "  }", "  return array;", "}"]),
...
Blockly.JavaScript.lists_getIndex = function (a) {
    var b = a.getFieldValue("MODE") || "GET",
        ...
        d = Blockly.JavaScript.valueToCode(a, "AT", Blockly.JavaScript.ORDER_UNARY_NEGATION) || "1";
...
Blockly.JavaScript.lists_getSublist = function (a) {
    var b = Blockly.JavaScript.valueToCode(a, "LIST", Blockly.JavaScript.ORDER_MEMBER) || "[]",
        ...
        e = Blockly.JavaScript.valueToCode(a, "AT1", Blockly.JavaScript.ORDER_NONE) || "1";
...
Blockly.JavaScript.maps_create_empty = function (a) {
    return ["{}", Blockly.JavaScript.ORDER_ATOMIC]
};
Blockly.JavaScript.maps_create_with = function (a) {
    var b = Blockly.JavaScript.variableDB_.getDistinctName("hashMap", Blockly.Variables.NAME_TYPE),
        c;
    Blockly.JavaScript.stashStatement(b + " = {};\n");
    for (var d = 0; d < a.itemCount_; d++) {
        var e = "ADD" + d;
        if (c = a.getInputTargetBlock(e))
            if ("maps_create" === c.type) e = Blockly.JavaScript.valueToCode(c, "VAL", Blockly.JavaScript.ORDER_NONE) || "null", c = Blockly.JavaScript.valueToCode(c, "KEY", Blockly.JavaScript.ORDER_NONE) || '""', c = b + "[" + c + "] = " + e + ";\n", Blockly.JavaScript.stashStatement(c);
            else if (c = Blockly.JavaScript.valueToCode(a, e, Blockly.JavaScript.ORDER_NONE)) c = "$.extend({}, " + b + ", " + c + ");\n", Blockly.JavaScript.stashStatement(c)
    }
    return [b, Blockly.JavaScript.ORDER_ATOMIC]
};
Blockly.JavaScript.maps_length = function (a) {
    return [(Blockly.JavaScript.valueToCode(a, "MAP", Blockly.JavaScript.ORDER_NONE) || "{}") + ".length", Blockly.JavaScript.ORDER_FUNCTION_CALL]
};
Blockly.JavaScript.maps_isempty = function (a) {
    a = Blockly.JavaScript.valueToCode(a, "MAP", Blockly.JavaScript.ORDER_NONE) || "";
    var b = a + ".length == 0";
    "" === a && (b = "true");
    return [b, Blockly.JavaScript.ORDER_LOGICAL_NOT]
};
Blockly.JavaScript.maps_create = function (a) {
    var b = Blockly.JavaScript.valueToCode(a, "VAL", Blockly.JavaScript.ORDER_NONE) || "null";
    a = Blockly.JavaScript.valueToCode(a, "KEY", Blockly.JavaScript.ORDER_NONE) || '""';
    var c = Blockly.JavaScript.variableDB_.getDistinctName("hashMap", Blockly.Variables.NAME_TYPE);
    Blockly.JavaScript.stashStatement(c + " = {};\n" + c + "[" + a + "] = " + b + ";\n");
    return [c, Blockly.JavaScript.ORDER_LOGICAL_NOT]
};
Blockly.JavaScript.maps_getIndex = function (a) {
    var b = a.getFieldValue("MODE") || "GET",
        c = Blockly.JavaScript.valueToCode(a, "KEY", Blockly.JavaScript.ORDER_NONE) || '""';
    a = Blockly.JavaScript.valueToCode(a, "MAP", Blockly.JavaScript.ORDER_MEMBER) || "";
    if ("GET" == b) return [a + "[" + c + "]", Blockly.JavaScript.ORDER_MEMBER];
    if ("GET_REMOVE" == b) return b = a + "[" + c + "];\n" + ("delete " + a + "[" + c + "]"), [b, Blockly.JavaScript.ORDER_FUNCTION_CALL];
    if ("REMOVE" == b) return "delete " + a + "[" + c + "];\n";
    throw "Unhandled combination (maps_getIndex).";
};
Blockly.JavaScript.maps_setIndex = function (a) {
    var b = Blockly.JavaScript.valueToCode(a, "MAP", Blockly.JavaScript.ORDER_MEMBER) || "{}",
        c = Blockly.JavaScript.valueToCode(a, "VAL", Blockly.JavaScript.ORDER_NONE) || "null";
    a = Blockly.JavaScript.valueToCode(a, "KEY", Blockly.JavaScript.ORDER_NONE) || '""';
    return b + "[" + a + "] = " + c + ";\n"
};
Blockly.JavaScript.maps_keys = function (a) {
    return ["Object.keys(" + (Blockly.JavaScript.valueToCode(a, "MAP", Blockly.JavaScript.ORDER_NONE) || "{}") + ")", Blockly.JavaScript.ORDER_LOGICAL_NOT]
};
...
Blockly.JavaScript.math_on_list = function (a) {
    ...
    switch (b) {
        ...
        case "MAX":
            ...
            break;
        case "AVERAGE":
            b = Blockly.JavaScript.provideFunction_("math_mean", ["function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(myList) {", "  return myList.reduce(function(x, y) {return x + y;}) / myList.length;", "}"]);
...
Blockly.JavaScript.procedures_defreturn = function (a) {
    ...
    d && (d = "  return " + d + ";\n");
    for (var e = [], f = 0; f < a.arguments_.length; f++) e[f] = Blockly.JavaScript.variableDB_.getName(a.arguments_[f].name, Blockly.Variables.NAME_TYPE);
    c = "function " + b + "(" + e.join(", ") + ") {\n" + c + d + "}";
...
Blockly.JavaScript.text_charAt = function (a) {
    var b = a.getFieldValue("WHERE") || "FROM_START",
        c = Blockly.JavaScript.valueToCode(a, "AT", Blockly.JavaScript.ORDER_UNARY_NEGATION) || "1";
    a = Blockly.JavaScript.valueToCode(a, "VALUE", Blockly.JavaScript.ORDER_MEMBER) || "''";
    switch (b) {
        case "FIRST":
...
Blockly.JavaScript.text_getSubstring = function (a) {
    var b = Blockly.JavaScript.valueToCode(a, "STRING", Blockly.JavaScript.ORDER_MEMBER) || "''",
        c = a.getFieldValue("WHERE1"),
        d = a.getFieldValue("WHERE2"),
        e = Blockly.JavaScript.valueToCode(a, "AT1", Blockly.JavaScript.ORDER_NONE) || "1";
    a = Blockly.JavaScript.valueToCode(a, "AT2", Blockly.JavaScript.ORDER_NONE) || "1";
...
Blockly.JavaScript.hash_variables_get = function (a) {
    var b = Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE);
    a = Blockly.JavaScript.quote_(a.getFieldValue("HASHKEY"));
    return [b + "[" + a + "]", Blockly.JavaScript.ORDER_ATOMIC]
};
Blockly.JavaScript.hash_variables_set = function (a) {
    var b = Blockly.JavaScript.valueToCode(a, "VALUE", Blockly.JavaScript.ORDER_NONE) || "0",
        c = Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE);
    a = Blockly.JavaScript.quote_(a.getFieldValue("HASHKEY"));
    return c + "[" + a + "] = " + b + "\n"
};
